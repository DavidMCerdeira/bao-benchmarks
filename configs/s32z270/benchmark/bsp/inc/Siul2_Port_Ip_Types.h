...
#define SIUL2_PORT_IP_TYPES_SW_PATCH_VERSION_H            1
...
#if ((SIUL2_PORT_IP_TYPES_AR_RELEASE_MAJOR_VERSION_H !=       \
 ...
 */
typedef enum {
    PORT_ANALOG_PAD_CONTROL_DISABLED = 0U, /*!< Disables the analog pad control to the associated
                                              pin. */
    PORT_ANALOG_PAD_CONTROL_ENABLED = 1U, /*!< Enables the analog pad control to the associated pin.
                                           */
    PORT_ANALOG_PAD_CONTROL_NOT_AVAILABLE = 2U /*!< The analog pad control to the associated pin is
                                                  not available.  */
...
typedef enum {
    ...
    PORT_HYSTERESIS_NOT_AVAILABLE = 2U /*!< The input hysteresis in the associated pin is not
                                          available.  */
 ...
 */
typedef enum {
    PORT_TERMINATION_RESISTOR_DISABLED = 0U, /*!< Disables the termination resistor to the
                                                associated pin. */
    PORT_TERMINATION_RESISTOR_ENABLED = 1U,  /*!< Enables the termination resistor to the associated
                                                pin.  */
 ...
 */
typedef enum {
    PORT_CURRENT_REFERENCE_CONTROL_DISABLED = 0U, /*!< Disables the current reference control to the
                                                     associated pin. */
    PORT_CURRENT_REFERENCE_CONTROL_ENABLED = 1U,  /*!< Enables the current reference control to the
                                                     associated pin.  */
 ...
 */
typedef enum {
    PORT_RX_CURRENT_BOOST_DISABLED = 0U, /*!< Current reference is 200 μA; supports data rate up to
                                            320 Mbaud. */
    PORT_RX_CURRENT_BOOST_ENABLED = 1U, /*!< Current reference is 1 mA; supports data rate up to 420
                                           Mbaud.  */
...
typedef struct {
...
#endif                                            /* FEATURE_SIUL2_PORT_IP_HAS_INPUT_FILTER */
#ifdef FEATURE_SIUL2_PORT_IP_HAS_RECEIVER_SELECT
    Siul2_Port_Ip_PortReceiverSelect receiverSel; /*!< Configures the Receiver Select, apply for
                                                     SIUL2_0/1        */
#endif                                            /* FEATURE_SIUL2_PORT_IP_HAS_RECEIVER_SELECT */
#ifdef FEATURE_SIUL2_PORT_IP_HAS_HYSTERESIS
...
#endif /* FEATURE_SIUL2_PORT_IP_HAS_TERMINATION_RESISTOR */
#ifdef FEATURE_SIUL2_PORT_IP_HAS_CURRENT_REFERENCE_CONTROL
    Siul2_Port_Ip_PortCurrentReferenceControl currentReferenceControl; /*!< Configures the Current
                                                                          Reference Control */
#endif /* FEATURE_SIUL2_PORT_IP_HAS_CURRENT_REFERENCE_CONTROL */
#ifdef FEATURE_SIUL2_PORT_IP_HAS_RX_CURRENT_BOOST
    ...
    Siul2_Port_Ip_PortInputMux inputMux[FEATURE_SIUL2_MAX_NUMBER_OF_INPUT_U8]; /*!< Configures the
                                                                                  input muxing */
