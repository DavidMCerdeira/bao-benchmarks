...
/* Check if Clock_Ip_Specific.h file and Clock_Ip_Derivative_001.h file are of the same Autosar
 * version */
#if ((CLOCK_IP_SPECIFIC_AR_RELEASE_MAJOR_VERSION !=           \
         CLOCK_IP_DERIVATIVE_001_AR_RELEASE_MAJOR_VERSION) || \
    (CLOCK_IP_SPECIFIC_AR_RELEASE_MINOR_VERSION !=            \
        CLOCK_IP_DERIVATIVE_001_AR_RELEASE_MINOR_VERSION) ||  \
    (CLOCK_IP_SPECIFIC_AR_RELEASE_REVISION_VERSION !=         \
        CLOCK_IP_DERIVATIVE_001_AR_RELEASE_REVISION_VERSION))
#error "AutoSar Version Numbers of Clock_Ip_Specific.h and Clock_Ip_Derivative_001.h are different"
#endif

/* Check if Clock_Ip_Specific.h file and Clock_Ip_Derivative_001.h file are of the same Software
 * version */
...
/* Check if Clock_Ip_Specific.h file and Clock_Ip_Derivative_002.h file are of the same Autosar
 * version */
#if ((CLOCK_IP_SPECIFIC_AR_RELEASE_MAJOR_VERSION !=           \
         CLOCK_IP_DERIVATIVE_002_AR_RELEASE_MAJOR_VERSION) || \
    (CLOCK_IP_SPECIFIC_AR_RELEASE_MINOR_VERSION !=            \
        CLOCK_IP_DERIVATIVE_002_AR_RELEASE_MINOR_VERSION) ||  \
    (CLOCK_IP_SPECIFIC_AR_RELEASE_REVISION_VERSION !=         \
        CLOCK_IP_DERIVATIVE_002_AR_RELEASE_REVISION_VERSION))
#error "AutoSar Version Numbers of Clock_Ip_Specific.h and Clock_Ip_Derivative_002.h are different"
#endif

/* Check if Clock_Ip_Specific.h file and Clock_Ip_Derivative_002.h file are of the same Software
 * version */
...
#define DFS_PORTSR_PORTSTAT_MASK                                                         \
    (DFS_PORTSR_PORTSTAT5_MASK | DFS_PORTSR_PORTSTAT4_MASK | DFS_PORTSR_PORTSTAT3_MASK | \
        DFS_PORTSR_PORTSTAT2_MASK | DFS_PORTSR_PORTSTAT1_MASK | DFS_PORTSR_PORTSTAT0_MASK)
...
extern Clock_Ip_CgmMuxType* const Clock_Ip_apxCgm[CLOCK_IP_MC_CGM_INSTANCES_COUNT]
                                                 [CLOCK_IP_MC_CGM_MUXS_COUNT];
...
extern Clock_Ip_GprClockControlEnable_Type* const
...
extern volatile uint32* const Clock_Ip_apxGprClkout[CLOCK_IP_GPR_INSTANCES_COUNT]
                                                   [CLOCK_IP_CLKOUTS_COUNT];
