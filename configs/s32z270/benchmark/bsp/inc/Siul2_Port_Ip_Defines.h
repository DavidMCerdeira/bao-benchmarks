 ...
 *        If the current platform implements REG_PROT for SIUL2 IP, this parameter will be defined,
 * and will enable REG_PROT configuration for SIUL2 IP in PORT drvier
 */
