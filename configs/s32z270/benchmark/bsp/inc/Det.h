...
#define DET_NO_ECU_CORES         (uint8)(14U)
...
extern uint8 Det_InstanceId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET instance
                                                                            ID*/
...
extern uint8 Det_RuntimeInstanceId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET
                                                                                   Runtime instance
                                                                                   ID*/
extern uint8 Det_RuntimeApiId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS];   /**< @brief DET Runtime
                                                                                API ID*/
extern uint8 Det_RuntimeErrorId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET Runtime
                                                                                Error ID*/
/* Variables to store last DET transient error */
extern uint8 Det_TransientInstanceId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET
                                                                                     Transient
                                                                                     instance ID*/
extern uint8 Det_TransientApiId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS];      /**< @brief DET
                                                                                     Transient API ID*/
extern uint8 Det_TransientFaultId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS];    /**< @brief DET
                                                                                     Transient Error
                                                                                     ID*/
...
#include "Det_MemMap.h"
extern uint16 Det_TransientModuleId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET
                                                                                    Transient module
                                                                                    ID*/
extern uint16 Det_ModuleId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET module ID*/
extern uint16 Det_RuntimeModuleId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET
                                                                                  Runtime module
                                                                                  ID*/
...
extern uint32 Det_numRuntimeEventErrors[DET_NO_ECU_CORES];   /**< @brief number of runtime DET error
                                                                ID*/
extern uint32 Det_numTransientEventErrors[DET_NO_ECU_CORES]; /**< @brief number of transient DET
                                                                error ID*/
