...
#if defined(INT8_MIN) && defined(INT16_MIN) && defined(INT16_MIN) && defined(INT32_MIN) &&   \
    defined(INT64_MIN) && defined(INT8_MAX) && defined(INT16_MAX) && defined(INT16_MAX) &&   \
    defined(INT32_MAX) && defined(INT64_MAX) && defined(UINT8_MAX) && defined(UINT16_MAX) && \
...
/**
@brief Unsigned integer at least 64 bit long. Range of at least 0 ..18446744073709551615
(0x0000000000000000..0xFFFFFFFFFFFFFFFF) - 64 bit
*/
...
/**
@brief Signed integer at least 64 bit long. Range - at least -9223372036854775808..
+9223372036854775807. At least 63 bit + 1 bit sign
*/
