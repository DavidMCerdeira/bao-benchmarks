...
#define SIUL2_PORT_IP_SW_PATCH_VERSION_H            1
...
/* Check if Siul2_Port_Ip.h and Siul2_Port_Ip_Cfg.h are of the same Autosar version */
    ...
    (SIUL2_PORT_IP_AR_RELEASE_REVISION_VERSION_H !=                                                \
        SIUL2_PORT_IP_AR_RELEASE_REVISION_VERSION_CFG_H))
...
#if ((SIUL2_PORT_IP_AR_RELEASE_MAJOR_VERSION_H !=                                                   \
...
#if ((SIUL2_PORT_IP_AR_RELEASE_MAJOR_VERSION_H !=             \
         SIUL2_PORT_IP_DEFINES_AR_RELEASE_MAJOR_VERSION_H) || \
    (SIUL2_PORT_IP_AR_RELEASE_MINOR_VERSION_H !=              \
        SIUL2_PORT_IP_DEFINES_AR_RELEASE_MINOR_VERSION_H) ||  \
    (SIUL2_PORT_IP_AR_RELEASE_REVISION_VERSION_H !=           \
        SIUL2_PORT_IP_DEFINES_AR_RELEASE_REVISION_VERSION_H))
...
#define SIUL2_MSCR_ADDR32(INSTANCE, PDAC, PIN)                            \
    ((Siul2_Port_Ip_CoreType)Port_au32Siul2BaseAddr[(INSTANCE)][(PDAC)] + \
        (Siul2_Port_Ip_CoreType)0x0240UL + (Siul2_Port_Ip_CoreType)((PIN) << 2))
#define SIUL2_IMCR_ADDR32(INSTANCE, PDAC, PIN)                            \
    ((Siul2_Port_Ip_CoreType)Port_au32Siul2BaseAddr[(INSTANCE)][(PDAC)] + \
        (Siul2_Port_Ip_CoreType)0x0A40UL + (Siul2_Port_Ip_CoreType)((PIN) << 2))
#define SIUL2_GPDO_ADDR8(INSTANCE, PDAC, PIN)                             \
    ((Siul2_Port_Ip_CoreType)Port_au32Siul2BaseAddr[(INSTANCE)][(PDAC)] + \
        (Siul2_Port_Ip_CoreType)0x1300UL + (((PIN) & ~3UL) | (~((PIN) & 3UL) & 3UL)))
#else
#define SIUL2_MSCR_ADDR32(INSTANCE, PIN)                          \
    ((Siul2_Port_Ip_CoreType)Port_au32Siul2BaseAddr[(INSTANCE)] + \
        (Siul2_Port_Ip_CoreType)0x0240UL + (Siul2_Port_Ip_CoreType)((PIN) << 2))
#define SIUL2_IMCR_ADDR32(INSTANCE, PIN)                          \
    ((Siul2_Port_Ip_CoreType)Port_au32Siul2BaseAddr[(INSTANCE)] + \
        (Siul2_Port_Ip_CoreType)0x0A40UL + (Siul2_Port_Ip_CoreType)((PIN) << 2))
#define SIUL2_GPDO_ADDR8(INSTANCE, PIN)                              \
    ((uint32)Port_au32Siul2BaseAddr[(INSTANCE)] + (uint32)0x1300UL + \
        (((PIN) & ~3UL) | (~((PIN) & 3UL) & 3UL)))
 ...
 *
 * @note: There are some pins controlled by both SIUL2_0, SIUL2_1, SIUL2_3, SIUL2_4 and SIUL2_5
 * instances In order to configure correctly and be consistent with other platforms, the inputMuxReg
 * parameter of SIUL2_3 instance must be added 512 units. For example: The actual inputMuxReg is 10
 * then the value there must be (10 + 512)
 */
...
/*!
 * @brief This function configures the pin configuration with the values from the configuration
 * structure
 *
