 ...
 * @details e007274 LINFlexD: Consecutive headers received by LIN Slave triggers the LIN FSM to an
 * unexpected state.
 */
...
* @details ERR051260 NETC: During initial Initialization of NETC, all ENETCs and Switch PCI
functions must be enabled for NETC to accept table management commands for any function
*/
 ...
 * @details ERR051587 NETC: Time gate scheduling update command may respond with error when
 * AdminBaseTime specified is near the current time.
 */
