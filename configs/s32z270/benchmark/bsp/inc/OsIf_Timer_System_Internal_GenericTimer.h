...
#define OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_MAJOR_VERSION            2
#define OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_MINOR_VERSION            0
#define OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_PATCH_VERSION            1

/*==================================================================================================
*                                       FILE VERSION CHECKS
==================================================================================================*/
/* Check if OsIf_Timer_System_Internal_GenericTimer.h file and OsIf_Cfg.h file are of the same
 * vendor */
...
/* Check if OsIf_Timer_System_Internal_GenericTimer.h file and OsIf_Cfg.h file are of the same
 * Autosar version */
#if ((OSIF_TIMER_SYS_INTER_GENERICTIMER_AR_RELEASE_MAJOR_VERSION !=   \
...
#error \
    "AUTOSAR Version Numbers of OsIf_Timer_System_Internal_GenericTimer.h and OsIf_Cfg.h are different"
#endif
/* Check if OsIf_Timer_System_Internal_GenericTimer.h file and OsIf_Cfg.h file are of the same
 * Software version */
...
#error \
    "Software Version Numbers of OsIf_Timer_System_Internal_GenericTimer.h and OsIf_Cfg.h are different"
#endif
