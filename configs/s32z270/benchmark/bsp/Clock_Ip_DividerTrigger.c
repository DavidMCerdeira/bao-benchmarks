...
static void
Clock_Ip_ConfigureCgmXDivTrigCtrlTctlHhenUpdStat(Clock_Ip_DividerTriggerConfigType const* Config);
static void Clock_Ip_TriggerUpdateCgmXDivTrigCtrlTctlHhenUpdStat(
    Clock_Ip_DividerTriggerConfigType const* Config);
#endif
...
Clock_Ip_ConfigureCgmXDivTrigCtrlTctlHhenUpdStat(Clock_Ip_DividerTriggerConfigType const* Config)
{
    ...
    if (NULL_PTR != Config) {
        ...
        if (Config->TriggerType != IMMEDIATE_DIVIDER_UPDATE) {
            Clock_Ip_apxCgm[Instance][SelectorIndex]->MUX_DIV_TRIG_CTRL =
    ...
    Clock_Ip_DividerTriggerConfigType const* Config)
{
    ...
    if (NULL_PTR != Config) {
        ...
        /* Check whether trigger is enabled */
        if (Config->TriggerType != IMMEDIATE_DIVIDER_UPDATE) {
            Clock_Ip_apxCgm[Instance][SelectorIndex]->MUX_DIV_TRIG =
                MC_CGM_MUX_DIV_TRIG_TRIGGER(CLOCK_IP_TRIGGER_VALUE);
