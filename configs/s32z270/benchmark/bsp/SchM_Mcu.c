...
void SchM_Check_mcu(void)
{
    ...
    reentry_guard_MCU_EXCLUSIVE_AREA_00[u32CoreId] = 0UL; /*reset
                                                             reentry_guard_MCU_EXCLUSIVE_AREA_00 for
                                                             the next test in the suite*/

    EU_ASSERT(0UL == reentry_guard_MCU_EXCLUSIVE_AREA_01[u32CoreId]);
    reentry_guard_MCU_EXCLUSIVE_AREA_01[u32CoreId] = 0UL; /*reset
                                                             reentry_guard_MCU_EXCLUSIVE_AREA_01 for
                                                             the next test in the suite*/

    EU_ASSERT(0UL == reentry_guard_MCU_EXCLUSIVE_AREA_02[u32CoreId]);
    reentry_guard_MCU_EXCLUSIVE_AREA_02[u32CoreId] = 0UL; /*reset
                                                             reentry_guard_MCU_EXCLUSIVE_AREA_02 for
                                                             the next test in the suite*/
}
