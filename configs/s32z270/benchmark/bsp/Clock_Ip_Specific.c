...
#define CLOCK_IP_SPECIFIC_SW_PATCH_VERSION_C            1
...
#define CLOCK_IP_DFS_PORT_RESET                                                          \
    (DFS_PORTRESET_RESET0_MASK | DFS_PORTRESET_RESET1_MASK | DFS_PORTRESET_RESET2_MASK | \
        DFS_PORTRESET_RESET3_MASK | DFS_PORTRESET_RESET4_MASK | DFS_PORTRESET_RESET5_MASK)
...
#define CLOCK_IP_RTU0_CORE_CLK_THRESHOLD1_FREQUENCY \
    (CLOCK_IP_RTU0_CORE_CLK_THRESHOLD0_FREQUENCY * (2U))
#define CLOCK_IP_RTU0_CORE_CLK_THRESHOLD2_FREQUENCY \
    (CLOCK_IP_RTU0_CORE_CLK_THRESHOLD0_FREQUENCY * (3U))
...
#define CLOCK_IP_RTU1_CORE_CLK_THRESHOLD1_FREQUENCY \
    (CLOCK_IP_RTU1_CORE_CLK_THRESHOLD0_FREQUENCY * (2U))
#define CLOCK_IP_RTU1_CORE_CLK_THRESHOLD2_FREQUENCY \
    (CLOCK_IP_RTU1_CORE_CLK_THRESHOLD0_FREQUENCY * (3U))

#define CLOCK_IP_SMU_M33_CORE_CLK_MAX_FREQUENCY 400000000U
#define CLOCK_IP_SMU_M33_CORE_CLK_THRESHOLD0_FREQUENCY \
    (CLOCK_IP_SMU_M33_CORE_CLK_MAX_FREQUENCY >> 2U)
#define CLOCK_IP_SMU_M33_CORE_CLK_THRESHOLD1_FREQUENCY \
    (CLOCK_IP_SMU_M33_CORE_CLK_THRESHOLD0_FREQUENCY * (2U))
#define CLOCK_IP_SMU_M33_CORE_CLK_THRESHOLD2_FREQUENCY \
    (CLOCK_IP_SMU_M33_CORE_CLK_THRESHOLD0_FREQUENCY * (3U))
...
#define CLOCK_IP_CE_M33_CORE_CLK_THRESHOLD1_FREQUENCY \
    (CLOCK_IP_CE_M33_CORE_CLK_THRESHOLD0_FREQUENCY * (2U))
#define CLOCK_IP_CE_M33_CORE_CLK_THRESHOLD2_FREQUENCY \
    (CLOCK_IP_CE_M33_CORE_CLK_THRESHOLD0_FREQUENCY * (3U))
...
static uint32 Clock_Ip_GetIwsSetting(uint32 ConfiguredCoreClockFrequnecy, uint32 Threshold0,
    uint32 Threshold1, uint32 Threshold2);
#endif
...
{
    uint32 RegValue;
    uint32 CoreDfsIsInReset = IP_CORE_DFS->CTL & DFS_CTL_DFS_RESET_MASK; /* if master core dfs is in
                                                                            reset */
    uint32 PeriphDfsIsInReset = IP_PERIPH_DFS->CTL & DFS_CTL_DFS_RESET_MASK; /* if master periph dfs
                                                                                is in reset */
    ...
    if ((CoreDfsIsInReset != 0U) && (PeriphDfsIsInReset != 0U)) {
        if ((IP_CORE_PLL->PLLCR & PLLDIG_PLLCR_PLLPD_MASK) != 0U) /* if CORE_PLL is not enabled */
        {
            ...
            IP_CORE_PLL->PLLDV =
                (RegValue | (PLLDIG_PLLDV_RDIV(1U) | PLLDIG_PLLDV_MFI(30U)));         /* /1 * 30 */

            IP_CORE_PLL->PLLFD &= ~(PLLDIG_PLLFD_MFN_MASK | PLLDIG_PLLFD_SDMEN_MASK); /* Disable
                                                                                         modulation
                                                                                       */
                                                                     ...
                                                                     */
        {
            ...
            IP_PERIPH_PLL->PLLFD &=
                ~(PLLDIG_PLLFD_MFN_MASK | PLLDIG_PLLFD_SDMEN_MASK);           /* Disable
                                                                                 modulation
                                                                               */
...
#if (defined(CLOCK_IP_ENABLE_USER_MODE_SUPPORT))
#if (STD_ON == CLOCK_IP_ENABLE_USER_MODE_SUPPORT)
#if (defined(CLOCK_IP_HAS_SYSTEM_DIV2_CLK) || defined(CLOCK_IP_HAS_SYSTEM_DIV4_MON1_CLK) || \
    defined(CLOCK_IP_HAS_SYSTEM_DIV4_MON2_CLK))
...
#endif /* (defined(CLOCK_IP_HAS_SYSTEM_DIV2_CLK) || defined(CLOCK_IP_HAS_SYSTEM_DIV4_MON1_CLK) || \
          defined(CLOCK_IP_HAS_SYSTEM_DIV4_MON2_CLK)) */
#endif
#endif /* CLOCK_IP_ENABLE_USER_MODE_SUPPORT */
...
void Clock_Ip_SRAMControllerSetRamIWS(uint32 SmuM33CoreClk_IwsSetting,
    uint32 Rtu0CoreClk_IwsSetting, uint32 Rtu1CoreClk_IwsSetting, uint32 CeM33CoreClk_IwsSetting)
{
#if (1 == 1)
...
#else
    IP_SMU__SRAMCTL_0->RAMCR |= ((IP_SMU__SRAMCTL_0->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(SmuM33CoreClk_IwsSetting));
    IP_SMU__SRAMCTL_1->RAMCR |= ((IP_SMU__SRAMCTL_1->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(SmuM33CoreClk_IwsSetting));
    IP_SMU__SRAMCTL_2->RAMCR |= ((IP_SMU__SRAMCTL_2->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(SmuM33CoreClk_IwsSetting));
    IP_SMU__SRAMCTL_3->RAMCR |= ((IP_SMU__SRAMCTL_3->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(SmuM33CoreClk_IwsSetting));

    IP_RTU0__SRAMCTL_C0->RAMCR |= ((IP_RTU0__SRAMCTL_C0->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu0CoreClk_IwsSetting));
    IP_RTU0__SRAMCTL_C1->RAMCR |= ((IP_RTU0__SRAMCTL_C1->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu0CoreClk_IwsSetting));
    IP_RTU0__SRAMCTL_C2->RAMCR |= ((IP_RTU0__SRAMCTL_C2->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu0CoreClk_IwsSetting));
    IP_RTU0__SRAMCTL_C3->RAMCR |= ((IP_RTU0__SRAMCTL_C3->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu0CoreClk_IwsSetting));
    IP_RTU0__SRAMCTL_C4->RAMCR |= ((IP_RTU0__SRAMCTL_C4->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu0CoreClk_IwsSetting));
    IP_RTU0__SRAMCTL_C5->RAMCR |= ((IP_RTU0__SRAMCTL_C5->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu0CoreClk_IwsSetting));
    IP_RTU0__SRAMCTL_C6->RAMCR |= ((IP_RTU0__SRAMCTL_C6->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu0CoreClk_IwsSetting));
    IP_RTU0__SRAMCTL_D0->RAMCR |= ((IP_RTU0__SRAMCTL_D0->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu0CoreClk_IwsSetting));
    IP_RTU0__SRAMCTL_D1->RAMCR |= ((IP_RTU0__SRAMCTL_D1->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu0CoreClk_IwsSetting));
    IP_RTU0__SRAMCTL_D2->RAMCR |= ((IP_RTU0__SRAMCTL_D2->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu0CoreClk_IwsSetting));

    IP_RTU1__SRAMCTL_C0->RAMCR |= ((IP_RTU1__SRAMCTL_C0->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu1CoreClk_IwsSetting));
    IP_RTU1__SRAMCTL_C1->RAMCR |= ((IP_RTU1__SRAMCTL_C1->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu1CoreClk_IwsSetting));
    IP_RTU1__SRAMCTL_C2->RAMCR |= ((IP_RTU1__SRAMCTL_C2->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu1CoreClk_IwsSetting));
    IP_RTU1__SRAMCTL_C3->RAMCR |= ((IP_RTU1__SRAMCTL_C3->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu1CoreClk_IwsSetting));
    IP_RTU1__SRAMCTL_C4->RAMCR |= ((IP_RTU1__SRAMCTL_C4->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu1CoreClk_IwsSetting));
    IP_RTU1__SRAMCTL_C5->RAMCR |= ((IP_RTU1__SRAMCTL_C5->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu1CoreClk_IwsSetting));
    IP_RTU1__SRAMCTL_C6->RAMCR |= ((IP_RTU1__SRAMCTL_C6->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu1CoreClk_IwsSetting));
    IP_RTU1__SRAMCTL_D0->RAMCR |= ((IP_RTU1__SRAMCTL_D0->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu1CoreClk_IwsSetting));
    IP_RTU1__SRAMCTL_D1->RAMCR |= ((IP_RTU1__SRAMCTL_D1->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu1CoreClk_IwsSetting));
    IP_RTU1__SRAMCTL_D2->RAMCR |= ((IP_RTU1__SRAMCTL_D2->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(Rtu1CoreClk_IwsSetting));

    IP_CE_SRAMCTL_0->RAMCR |= ((IP_CE_SRAMCTL_0->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(CeM33CoreClk_IwsSetting));
    IP_CE_SRAMCTL_1->RAMCR |= ((IP_CE_SRAMCTL_1->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(CeM33CoreClk_IwsSetting));
    IP_CE_SRAMCTL_2->RAMCR |= ((IP_CE_SRAMCTL_2->RAMCR & ~SRAMCTL_RAMCR_IWS_MASK) |
        SRAMCTL_RAMCR_IWS(CeM33CoreClk_IwsSetting));
#endif
}
...
void Clock_Ip_SetRamWaitStates(void)
{
    ...
    Rtu0CoreClk_ConfiguredFrequency =
        (*Clock_Ip_pxConfig->ConfiguredFrequencies)[Clock_Ip_FreqIds[RTU0_CORE_CLK]]
            .ConfiguredFrequencyValue;
#endif
#if defined(CLOCK_IP_HAS_RTU1_CORE_CLK)
    Rtu1CoreClk_ConfiguredFrequency =
        (*Clock_Ip_pxConfig->ConfiguredFrequencies)[Clock_Ip_FreqIds[RTU1_CORE_CLK]]
            .ConfiguredFrequencyValue;
#endif
#if defined(CLOCK_IP_HAS_SMU_M33_CORE_CLK)
    SmuM33CoreClk_ConfiguredFrequency =
        (*Clock_Ip_pxConfig->ConfiguredFrequencies)[Clock_Ip_FreqIds[SMU_M33_CORE_CLK]]
            .ConfiguredFrequencyValue;
#endif
#if defined(CLOCK_IP_HAS_CE_M33_CORE_CLK)
    CeM33CoreClk_ConfiguredFrequency =
        (*Clock_Ip_pxConfig->ConfiguredFrequencies)[Clock_Ip_FreqIds[CE_M33_CORE_CLK]]
            .ConfiguredFrequencyValue;
#endif
    ...
    SmuM33CoreClk_IwsSetting = Clock_Ip_GetIwsSetting(SmuM33CoreClk_ConfiguredFrequency,
        CLOCK_IP_SMU_M33_CORE_CLK_THRESHOLD0_FREQUENCY,
        CLOCK_IP_SMU_M33_CORE_CLK_THRESHOLD1_FREQUENCY,
        CLOCK_IP_SMU_M33_CORE_CLK_THRESHOLD2_FREQUENCY);
    Rtu0CoreClk_IwsSetting = Clock_Ip_GetIwsSetting(Rtu0CoreClk_ConfiguredFrequency,
        CLOCK_IP_RTU0_CORE_CLK_THRESHOLD0_FREQUENCY, CLOCK_IP_RTU0_CORE_CLK_THRESHOLD1_FREQUENCY,
        CLOCK_IP_RTU0_CORE_CLK_THRESHOLD2_FREQUENCY);
    Rtu1CoreClk_IwsSetting = Clock_Ip_GetIwsSetting(Rtu1CoreClk_ConfiguredFrequency,
        CLOCK_IP_RTU1_CORE_CLK_THRESHOLD0_FREQUENCY, CLOCK_IP_RTU1_CORE_CLK_THRESHOLD1_FREQUENCY,
        CLOCK_IP_RTU1_CORE_CLK_THRESHOLD2_FREQUENCY);
    CeM33CoreClk_IwsSetting = Clock_Ip_GetIwsSetting(CeM33CoreClk_ConfiguredFrequency,
        CLOCK_IP_CE_M33_CORE_CLK_THRESHOLD0_FREQUENCY,
        CLOCK_IP_CE_M33_CORE_CLK_THRESHOLD1_FREQUENCY,
        CLOCK_IP_CE_M33_CORE_CLK_THRESHOLD2_FREQUENCY);

#ifdef CLOCK_IP_ENABLE_USER_MODE_SUPPORT
#if (STD_ON == CLOCK_IP_ENABLE_USER_MODE_SUPPORT)
    OsIf_Trusted_Call4params(Clock_Ip_SRAMControllerSetRamIWS, (SmuM33CoreClk_IwsSetting),
        (Rtu0CoreClk_IwsSetting), (Rtu1CoreClk_IwsSetting), (CeM33CoreClk_IwsSetting));
#else
    Clock_Ip_SRAMControllerSetRamIWS(SmuM33CoreClk_IwsSetting, Rtu0CoreClk_IwsSetting,
        Rtu1CoreClk_IwsSetting, CeM33CoreClk_IwsSetting);
#endif
#else
    Clock_Ip_SRAMControllerSetRamIWS(SmuM33CoreClk_IwsSetting, Rtu0CoreClk_IwsSetting,
        Rtu1CoreClk_IwsSetting, CeM33CoreClk_IwsSetting);
