...
#define CLOCK_IP_FREQUENCY_SW_PATCH_VERSION_C            1
...
==================================================================================================*/
extern uint64_t __aeabi_uldivmod(uint64_t numerator, uint64_t denominator, uint64_t* remainder);
...
static const getFreqType Clock_Ip_apfFreqTableCLKOUT0SEL[CLOCK_IP_SELECTOR_SOURCE_NO] = {
    ...
    &Clock_Ip_Get_P0_REG_INTF_2X_CLK_Frequency, /* clock name for 26 hardware value
                                                   P0_REG_INTF_2X_CLK */
    ...
    &Clock_Ip_Get_P0_PSI5_189K_CLK_Frequency, /* clock name for 29 hardware value P0_PSI5_189K_CLK
                                               */
    &Clock_Ip_Get_P0_PSI5_S_UTIL_CLK_Frequency, /* clock name for 30 hardware value
                                                   P0_PSI5_S_UTIL_CLK */
    &Clock_Ip_Get_P0_PSI5_S_UART_CLK_Frequency, /* clock name for 31 hardware value
                                                   P0_PSI5_S_UART_CLK */
    &Clock_Ip_Get_P0_PSI5_S_BAUD_CLK_Frequency, /* clock name for 32 hardware value
                                                   P0_PSI5_S_BAUD_CLK */
    &Clock_Ip_Get_P0_PSI5_S_CORE_CLK_Frequency, /* clock name for 33 hardware value
                                                   P0_PSI5_S_CORE_CLK */
    ...
    &Clock_Ip_Get_P0_EMIOS_LCU_CLK_Frequency, /* clock name for 44 hardware value P0_EMIOS_LCU_CLK
                                               */
    &Clock_Ip_Get_CORE_PLL_REFCLKOUT_Frequency, /* clock name for 45 hardware value
                                                   CORE_PLL_REFCLKOUT */
    &Clock_Ip_Get_COREPLL_CLK_Frequency, /* clock name for 46 hardware value CORE_PLL_FBCLKOUT */
    &Clock_Ip_Get_PERIPH_PLL_REFCLKOUT_Frequency, /* clock name for 47 hardware value
                                                     PERIPH_PLL_REFCLKOUT */
...
static const getFreqType Clock_Ip_apfFreqTableCLKOUT2SEL[CLOCK_IP_SELECTOR_SOURCE_NO] = {
    ...
    &Clock_Ip_Get_P4_REG_INTF_2X_CLK_Frequency, /* clock name for 4  hardware value
                                                   P4_REG_INTF_2X_CLK */
    ...
    &Clock_Ip_Get_P4_PSI5_189K_CLK_Frequency, /* clock name for 7  hardware value P4_PSI5_189K_CLK
                                               */
    &Clock_Ip_Get_P4_PSI5_S_UTIL_CLK_Frequency, /* clock name for 8  hardware value
                                                   P4_PSI5_S_UTIL_CLK */
    &Clock_Ip_Get_P4_PSI5_S_UART_CLK_Frequency, /* clock name for 9  hardware value
                                                   P4_PSI5_S_UART_CLK */
    &Clock_Ip_Get_P4_PSI5_S_BAUD_CLK_Frequency, /* clock name for 10 hardware value
                                                   P4_PSI5_S_BAUD_CLK */
    &Clock_Ip_Get_P4_PSI5_S_CORE_CLK_Frequency, /* clock name for 11 hardware value
                                                   P4_PSI5_S_CORE_CLK */
    ...
    &Clock_Ip_Get_P4_SDHC_IP_DIV2_CLK_Frequency, /* clock name for 22 hardware value
                                                    P4_SDHC_IP_DIV2_CLK */
...
static const getFreqType Clock_Ip_apfFreqTableCLKOUT4SEL[CLOCK_IP_SELECTOR_SOURCE_NO] = {
    ...
    &Clock_Ip_Get_RTU0_CORE_DIV2_CLK_Frequency,  /* clock name for 7  hardware value
                                                    RTU0_CORE_DIV2_CLK */
    &Clock_Ip_Get_RTU1_CORE_DIV2_CLK_Frequency,  /* clock name for 8  hardware value
                                                    RTU1_CORE_DIV2_CLK */
    &Clock_Ip_Get_DDR_CLK_Frequency,             /* clock name for 9  hardware value DDR_CLK */
    &Clock_Ip_Get_P3_SYS_DIV2_NOC_CLK_Frequency, /* clock name for 10 hardware value
                                                    P3_SYS_DIV2_NOC_CLK */
    &Clock_Ip_Get_Zero_Frequency,                /* clock name for 11 hardware value */
    &Clock_Ip_Get_Zero_Frequency,                /* clock name for 12 hardware value */
    &Clock_Ip_Get_Zero_Frequency,                /* clock name for 13 hardware value */
...
static const getFreqType Clock_Ip_apfFreqTablePSI5_S_UTIL_MULTIPLEX[CLOCK_IP_CLKPSI5_S_UTIL_NO] = {
    &Clock_Ip_Get_P0_PSI5_S_UTIL_CLK_Frequency, /* clock name for 0  hardware value
                                                   P0_PSI5_S_UTIL_CLK */
    &Clock_Ip_Get_P4_PSI5_S_UTIL_CLK_Frequency, /* clock name for 1  hardware value
                                                   P4_PSI5_S_UTIL_CLK */
};
...
static extSignalFreq Clock_Ip_axExtSignalFreqEntries[CLOCK_IP_EXT_SIGNALS_NO] = {
    { ETH_RGMII_REF_CLK, 0U }, { TMR_1588_CLK, 0U }, { ETH0_EXT_RX_CLK, 0U },
    { ETH0_EXT_TX_CLK, 0U }, { ETH1_EXT_RX_CLK, 0U }, { ETH1_EXT_TX_CLK, 0U },
    { LFAST0_EXT_REF_CLK, 0U }, { LFAST1_EXT_REF_CLK, 0U }
};
...
static uint64 Clock_Ip_Get_COREPLL_CLK_Frequency(void)
{
    if (Clock_Ip_u64CorePllChecksum !=
        (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^ (uint64)IP_CORE_PLL->PLLDV ^
            (uint64)IP_CORE_PLL->PLLFD)) {
        Clock_Ip_u64CorePllChecksum = (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^
            (uint64)IP_CORE_PLL->PLLDV ^ (uint64)IP_CORE_PLL->PLLFD);
        Clock_Ip_u64CorePllFreq = Clock_Ip_Get_PLL_VCO(IP_CORE_PLL);
    }
    return (((IP_CORE_PLL->PLLSR & PLLDIG_PLLSR_LOCK_MASK) >> PLLDIG_PLLSR_LOCK_SHIFT) != 0U) ?
        Clock_Ip_u64CorePllFreq :
        0U;
}
/* Return PERIPHPLL_CLK frequency */
static uint64 Clock_Ip_Get_PERIPHPLL_CLK_Frequency(void)
{
    if (Clock_Ip_u64PeriphPllChecksum !=
        (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^ (uint64)IP_PERIPH_PLL->PLLDV ^
            (uint64)IP_PERIPH_PLL->PLLFD)) {
        Clock_Ip_u64PeriphPllChecksum = (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^
            (uint64)IP_PERIPH_PLL->PLLDV ^ (uint64)IP_PERIPH_PLL->PLLFD);
        Clock_Ip_u64PeriphPllFreq = Clock_Ip_Get_PLL_VCO(IP_PERIPH_PLL);
    }
    return (((IP_PERIPH_PLL->PLLSR & PLLDIG_PLLSR_LOCK_MASK) >> PLLDIG_PLLSR_LOCK_SHIFT) != 0U) ?
        Clock_Ip_u64PeriphPllFreq :
        0U;
}
/* Return DDRPLL_CLK frequency */
static uint64 Clock_Ip_Get_DDRPLL_CLK_Frequency(void)
{
    if (Clock_Ip_u64DdrPllChecksum !=
        (uint64)((uint64)IP_DDR_PLL->PLLCLKMUX ^ (uint64)IP_DDR_PLL->PLLDV ^
            (uint64)IP_DDR_PLL->PLLFD)) {
        Clock_Ip_u64DdrPllChecksum = (uint64)((uint64)IP_DDR_PLL->PLLCLKMUX ^
            (uint64)IP_DDR_PLL->PLLDV ^ (uint64)IP_DDR_PLL->PLLFD);
        Clock_Ip_u64DdrPllFreq = Clock_Ip_Get_PLL_VCO(IP_DDR_PLL);
    }
    return (((IP_DDR_PLL->PLLSR & PLLDIG_PLLSR_LOCK_MASK) >> PLLDIG_PLLSR_LOCK_SHIFT) != 0U) ?
        Clock_Ip_u64DdrPllFreq :
        0U;
}
...
static uint64 Clock_Ip_Get_COREPLL_PHI0_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_au32EnableDivider[((IP_CORE_PLL->PLLODIV[0U] & PLLDIG_PLLODIV_DE_MASK) >>
        PLLDIG_PLLODIV_DE_SHIFT)]; /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_CORE_PLL->PLLODIV[0U] & (uint64)PLLDIG_PLLODIV_DIV_MASK) >>
                              (uint64)PLLDIG_PLLODIV_DIV_SHIFT) +
...
static uint64 Clock_Ip_Get_COREPLL_DFS0_Frequency(void)
{
    if (Clock_Ip_u64CoreDfs1Checksum !=
        (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^ (uint64)IP_CORE_PLL->PLLDV ^
            (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[0U])) {
        Clock_Ip_u64CoreDfs1Checksum = (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^
            (uint64)IP_CORE_PLL->PLLDV ^ (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[0U]);
        Clock_Ip_u64CoreDfs1Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_CORE_DFS, 0U, Clock_Ip_Get_COREPLL_CLK_Frequency());
    }
    return ((((IP_CORE_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_0_CHANNEL) != 0U) ?
        Clock_Ip_u64CoreDfs1Freq :
        0U;
}
...
static uint64 Clock_Ip_Get_COREPLL_DFS1_Frequency(void)
{
    if (Clock_Ip_u64CoreDfs2Checksum !=
        (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^ (uint64)IP_CORE_PLL->PLLDV ^
            (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[1U])) {
        Clock_Ip_u64CoreDfs2Checksum = (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^
            (uint64)IP_CORE_PLL->PLLDV ^ (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[1U]);
        Clock_Ip_u64CoreDfs2Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_CORE_DFS, 1U, Clock_Ip_Get_COREPLL_CLK_Frequency());
    }
    return ((((IP_CORE_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_1_CHANNEL) != 0U) ?
        Clock_Ip_u64CoreDfs2Freq :
        0U;
}
...
static uint64 Clock_Ip_Get_COREPLL_DFS2_Frequency(void)
{
    if (Clock_Ip_u64CoreDfs3Checksum !=
        (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^ (uint64)IP_CORE_PLL->PLLDV ^
            (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[2U])) {
        Clock_Ip_u64CoreDfs3Checksum = (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^
            (uint64)IP_CORE_PLL->PLLDV ^ (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[2U]);
        Clock_Ip_u64CoreDfs3Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_CORE_DFS, 2U, Clock_Ip_Get_COREPLL_CLK_Frequency());
    }
    return ((((IP_CORE_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_2_CHANNEL) != 0U) ?
        Clock_Ip_u64CoreDfs3Freq :
        0U;
}
...
static uint64 Clock_Ip_Get_COREPLL_DFS3_Frequency(void)
{
    if (Clock_Ip_u64CoreDfs4Checksum !=
        (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^ (uint64)IP_CORE_PLL->PLLDV ^
            (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[3U])) {
        Clock_Ip_u64CoreDfs4Checksum = (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^
            (uint64)IP_CORE_PLL->PLLDV ^ (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[3U]);
        Clock_Ip_u64CoreDfs4Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_CORE_DFS, 3U, Clock_Ip_Get_COREPLL_CLK_Frequency());
    }
    return ((((IP_CORE_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_3_CHANNEL) != 0U) ?
        Clock_Ip_u64CoreDfs4Freq :
        0U;
}
...
static uint64 Clock_Ip_Get_COREPLL_DFS4_Frequency(void)
{
    if (Clock_Ip_u64CoreDfs5Checksum !=
        (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^ (uint64)IP_CORE_PLL->PLLDV ^
            (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[4U])) {
        Clock_Ip_u64CoreDfs5Checksum = (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^
            (uint64)IP_CORE_PLL->PLLDV ^ (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[4U]);
        Clock_Ip_u64CoreDfs5Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_CORE_DFS, 4U, Clock_Ip_Get_COREPLL_CLK_Frequency());
    }
    return ((((IP_CORE_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_4_CHANNEL) != 0U) ?
        Clock_Ip_u64CoreDfs5Freq :
        0U;
}
...
static uint64 Clock_Ip_Get_COREPLL_DFS5_Frequency(void)
{
    if (Clock_Ip_u64CoreDfs6Checksum !=
        (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^ (uint64)IP_CORE_PLL->PLLDV ^
            (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[5U])) {
        Clock_Ip_u64CoreDfs6Checksum = (uint64)((uint64)IP_CORE_PLL->PLLCLKMUX ^
            (uint64)IP_CORE_PLL->PLLDV ^ (uint64)IP_CORE_PLL->PLLFD ^ (uint64)IP_CORE_PLL->PLLSR ^
            (uint64)IP_CORE_DFS->DVPORT[5U]);
        Clock_Ip_u64CoreDfs6Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_CORE_DFS, 5U, Clock_Ip_Get_COREPLL_CLK_Frequency());
    }
    return ((((IP_CORE_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_5_CHANNEL) != 0U) ?
        Clock_Ip_u64CoreDfs6Freq :
        0U;
}
...
static uint64 Clock_Ip_Get_PERIPHPLL_PHI0_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_PERIPH_PLL->PLLODIV[0U] & PLLDIG_PLLODIV_DE_MASK) >>
            PLLDIG_PLLODIV_DE_SHIFT)]; /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_PERIPH_PLL->PLLODIV[0U] & (uint64)PLLDIG_PLLODIV_DIV_MASK) >>
                              (uint64)PLLDIG_PLLODIV_DIV_SHIFT) +
        1U);                           /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PERIPHPLL_PHI1_Frequency(void)
{
    uint64 Frequency = Clock_Ip_Get_PERIPHPLL_CLK_Frequency();
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_PERIPH_PLL->PLLODIV[1U] & PLLDIG_PLLODIV_DE_MASK) >>
            PLLDIG_PLLODIV_DE_SHIFT)]; /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_PERIPH_PLL->PLLODIV[1U] & (uint64)PLLDIG_PLLODIV_DIV_MASK) >>
                              (uint64)PLLDIG_PLLODIV_DIV_SHIFT) +
        1U);                           /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PERIPHPLL_PHI2_Frequency(void)
{
    uint64 Frequency = Clock_Ip_Get_PERIPHPLL_CLK_Frequency();
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_PERIPH_PLL->PLLODIV[2U] & PLLDIG_PLLODIV_DE_MASK) >>
            PLLDIG_PLLODIV_DE_SHIFT)]; /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_PERIPH_PLL->PLLODIV[2U] & (uint64)PLLDIG_PLLODIV_DIV_MASK) >>
                              (uint64)PLLDIG_PLLODIV_DIV_SHIFT) +
        1U);                           /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PERIPHPLL_PHI3_Frequency(void)
{
    uint64 Frequency = Clock_Ip_Get_PERIPHPLL_CLK_Frequency();
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_PERIPH_PLL->PLLODIV[3U] & PLLDIG_PLLODIV_DE_MASK) >>
            PLLDIG_PLLODIV_DE_SHIFT)]; /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_PERIPH_PLL->PLLODIV[3U] & (uint64)PLLDIG_PLLODIV_DIV_MASK) >>
                              (uint64)PLLDIG_PLLODIV_DIV_SHIFT) +
        1U);                           /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PERIPHPLL_PHI4_Frequency(void)
{
    uint64 Frequency = Clock_Ip_Get_PERIPHPLL_CLK_Frequency();
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_PERIPH_PLL->PLLODIV[4U] & PLLDIG_PLLODIV_DE_MASK) >>
            PLLDIG_PLLODIV_DE_SHIFT)]; /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_PERIPH_PLL->PLLODIV[4U] & (uint64)PLLDIG_PLLODIV_DIV_MASK) >>
                              (uint64)PLLDIG_PLLODIV_DIV_SHIFT) +
        1U);                           /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PERIPHPLL_PHI5_Frequency(void)
{
    uint64 Frequency = Clock_Ip_Get_PERIPHPLL_CLK_Frequency();
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_PERIPH_PLL->PLLODIV[5U] & PLLDIG_PLLODIV_DE_MASK) >>
            PLLDIG_PLLODIV_DE_SHIFT)]; /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_PERIPH_PLL->PLLODIV[5U] & (uint64)PLLDIG_PLLODIV_DIV_MASK) >>
                              (uint64)PLLDIG_PLLODIV_DIV_SHIFT) +
        1U);                           /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PERIPHPLL_PHI6_Frequency(void)
{
    uint64 Frequency = Clock_Ip_Get_PERIPHPLL_CLK_Frequency();
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_PERIPH_PLL->PLLODIV[6U] & PLLDIG_PLLODIV_DE_MASK) >>
            PLLDIG_PLLODIV_DE_SHIFT)]; /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_PERIPH_PLL->PLLODIV[6U] & (uint64)PLLDIG_PLLODIV_DIV_MASK) >>
                              (uint64)PLLDIG_PLLODIV_DIV_SHIFT) +
        1U);                           /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PERIPHPLL_DFS0_Frequency(void)
{
    if (Clock_Ip_u64PeriphDfs1Checksum !=
        (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^ (uint64)IP_PERIPH_PLL->PLLDV ^
            (uint64)IP_PERIPH_PLL->PLLFD ^ (uint64)IP_PERIPH_PLL->PLLSR ^
            (uint64)IP_PERIPH_DFS->DVPORT[0U])) {
        Clock_Ip_u64PeriphDfs1Checksum = (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^
            (uint64)IP_PERIPH_PLL->PLLDV ^ (uint64)IP_PERIPH_PLL->PLLFD ^
            (uint64)IP_PERIPH_PLL->PLLSR ^ (uint64)IP_PERIPH_DFS->DVPORT[0U]);
        Clock_Ip_u64PeriphDfs1Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_PERIPH_DFS, 0U, Clock_Ip_Get_PERIPHPLL_CLK_Frequency());
    }
    return ((((IP_PERIPH_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_0_CHANNEL) != 0U) ?
        Clock_Ip_u64PeriphDfs1Freq :
        0U;
}
...
static uint64 Clock_Ip_Get_PERIPHPLL_DFS1_Frequency(void)
{
    if (Clock_Ip_u64PeriphDfs2Checksum !=
        (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^ (uint64)IP_PERIPH_PLL->PLLDV ^
            (uint64)IP_PERIPH_PLL->PLLFD ^ (uint64)IP_PERIPH_PLL->PLLSR ^
            (uint64)IP_PERIPH_DFS->DVPORT[1U])) {
        Clock_Ip_u64PeriphDfs2Checksum = (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^
            (uint64)IP_PERIPH_PLL->PLLDV ^ (uint64)IP_PERIPH_PLL->PLLFD ^
            (uint64)IP_PERIPH_PLL->PLLSR ^ (uint64)IP_PERIPH_DFS->DVPORT[1U]);
        Clock_Ip_u64PeriphDfs2Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_PERIPH_DFS, 1U, Clock_Ip_Get_PERIPHPLL_CLK_Frequency());
    }
    return ((((IP_PERIPH_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_1_CHANNEL) != 0U) ?
        Clock_Ip_u64PeriphDfs2Freq :
...
static uint64 Clock_Ip_Get_PERIPHPLL_DFS2_Frequency(void)
{
    if (Clock_Ip_u64PeriphDfs3Checksum !=
        (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^ (uint64)IP_PERIPH_PLL->PLLDV ^
            (uint64)IP_PERIPH_PLL->PLLFD ^ (uint64)IP_PERIPH_PLL->PLLSR ^
            (uint64)IP_PERIPH_DFS->DVPORT[2U])) {
        Clock_Ip_u64PeriphDfs3Checksum = (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^
            (uint64)IP_PERIPH_PLL->PLLDV ^ (uint64)IP_PERIPH_PLL->PLLFD ^
            (uint64)IP_PERIPH_PLL->PLLSR ^ (uint64)IP_PERIPH_DFS->DVPORT[2U]);
        Clock_Ip_u64PeriphDfs3Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_PERIPH_DFS, 2U, Clock_Ip_Get_PERIPHPLL_CLK_Frequency());
    }
    return ((((IP_PERIPH_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_2_CHANNEL) != 0U) ?
        Clock_Ip_u64PeriphDfs3Freq :
...
static uint64 Clock_Ip_Get_PERIPHPLL_DFS3_Frequency(void)
{
    if (Clock_Ip_u64PeriphDfs4Checksum !=
        (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^ (uint64)IP_PERIPH_PLL->PLLDV ^
            (uint64)IP_PERIPH_PLL->PLLFD ^ (uint64)IP_PERIPH_PLL->PLLSR ^
            (uint64)IP_PERIPH_DFS->DVPORT[3U])) {
        Clock_Ip_u64PeriphDfs4Checksum = (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^
            (uint64)IP_PERIPH_PLL->PLLDV ^ (uint64)IP_PERIPH_PLL->PLLFD ^
            (uint64)IP_PERIPH_PLL->PLLSR ^ (uint64)IP_PERIPH_DFS->DVPORT[3U]);
        Clock_Ip_u64PeriphDfs4Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_PERIPH_DFS, 3U, Clock_Ip_Get_PERIPHPLL_CLK_Frequency());
    }
    return ((((IP_PERIPH_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_3_CHANNEL) != 0U) ?
        Clock_Ip_u64PeriphDfs4Freq :
...
static uint64 Clock_Ip_Get_PERIPHPLL_DFS4_Frequency(void)
{
    if (Clock_Ip_u64PeriphDfs5Checksum !=
        (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^ (uint64)IP_PERIPH_PLL->PLLDV ^
            (uint64)IP_PERIPH_PLL->PLLFD ^ (uint64)IP_PERIPH_PLL->PLLSR ^
            (uint64)IP_PERIPH_DFS->DVPORT[4U])) {
        Clock_Ip_u64PeriphDfs5Checksum = (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^
            (uint64)IP_PERIPH_PLL->PLLDV ^ (uint64)IP_PERIPH_PLL->PLLFD ^
            (uint64)IP_PERIPH_PLL->PLLSR ^ (uint64)IP_PERIPH_DFS->DVPORT[4U]);
        Clock_Ip_u64PeriphDfs5Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_PERIPH_DFS, 4U, Clock_Ip_Get_PERIPHPLL_CLK_Frequency());
    }
    return ((((IP_PERIPH_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_4_CHANNEL) != 0U) ?
        Clock_Ip_u64PeriphDfs5Freq :
...
static uint64 Clock_Ip_Get_PERIPHPLL_DFS5_Frequency(void)
{
    if (Clock_Ip_u64PeriphDfsChecksum !=
        (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^ (uint64)IP_PERIPH_PLL->PLLDV ^
            (uint64)IP_PERIPH_PLL->PLLFD ^ (uint64)IP_PERIPH_PLL->PLLSR ^
            (uint64)IP_PERIPH_DFS->DVPORT[5U])) {
        Clock_Ip_u64PeriphDfsChecksum = (uint64)((uint64)IP_PERIPH_PLL->PLLCLKMUX ^
            (uint64)IP_PERIPH_PLL->PLLDV ^ (uint64)IP_PERIPH_PLL->PLLFD ^
            (uint64)IP_PERIPH_PLL->PLLSR ^ (uint64)IP_PERIPH_DFS->DVPORT[5U]);
        Clock_Ip_u64PeriphDfs6Freq =
            Clock_Ip_Get_DFS_OUTPUT(IP_PERIPH_DFS, 5U, Clock_Ip_Get_PERIPHPLL_CLK_Frequency());
    }
    return ((((IP_PERIPH_DFS->PORTSR >> DFS_PORTSR_PORTSTAT_SHIFT) & DFS_PORTSR_PORTSTAT_MASK) &
                CLOCK_IP_DFS_MASK_5_CHANNEL) != 0U) ?
        Clock_Ip_u64PeriphDfs6Freq :
...
static uint64 Clock_Ip_Get_DDRPLL_PHI0_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_au32EnableDivider[((IP_DDR_PLL->PLLODIV[0U] & PLLDIG_PLLODIV_DE_MASK) >>
        PLLDIG_PLLODIV_DE_SHIFT)]; /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_DDR_PLL->PLLODIV[0U] & (uint64)PLLDIG_PLLODIV_DIV_MASK) >>
                              (uint64)PLLDIG_PLLODIV_DIV_SHIFT) +
        1U);                       /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_FR_PE_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_6_CSS & MC_CGM_MUX_6_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_6_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_6_DC_0 & MC_CGM_MUX_6_DC_0_DE_MASK) >>
            MC_CGM_MUX_6_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_6_DC_0 & (uint64)MC_CGM_MUX_6_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_6_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_FRAY0_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_6_DC_0 & (uint64)MC_CGM_MUX_6_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_6_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->FR0PCTL & GPR0_PCTL_FR0PCTL_PCTL_MASK) >>
        GPR0_PCTL_FR0PCTL_PCTL_SHIFT)];         /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_FRAY1_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_6_DC_0 & (uint64)MC_CGM_MUX_6_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_6_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->FR1PCTL & GPR0_PCTL_FR1PCTL_PCTL_MASK) >>
        GPR0_PCTL_FR1PCTL_PCTL_SHIFT)];         /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_GTM_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_7_CSS & MC_CGM_MUX_7_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_7_CSS_SELSTAT_SHIFT)]();     /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_7_DC_0 & MC_CGM_MUX_7_DC_0_DE_MASK) >>
            MC_CGM_MUX_7_DC_0_DE_SHIFT)];           /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_7_DC_0 & (uint64)MC_CGM_MUX_7_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_7_DC_0_DIV_SHIFT) +
        1U);                                        /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->GTMNANOPCTL & GPR0_PCTL_GTMNANOPCTL_PCTL_GTM_MASK) >>
            GPR0_PCTL_GTMNANOPCTL_PCTL_GTM_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_LIN_BAUD_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_4_CSS & MC_CGM_MUX_4_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_4_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_4_DC_0 & MC_CGM_MUX_4_DC_0_DE_MASK) >>
            MC_CGM_MUX_4_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_LIN0_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->LIN0PCTL & GPR0_PCTL_LIN0PCTL_PCTL_MASK) >>
        GPR0_PCTL_LIN0PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_LIN1_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->LIN1PCTL & GPR0_PCTL_LIN1PCTL_PCTL_MASK) >>
        GPR0_PCTL_LIN1PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_LIN2_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->LIN2PCTL & GPR0_PCTL_LIN2PCTL_PCTL_MASK) >>
        GPR0_PCTL_LIN2PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P1_LIN_BAUD_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_4_CSS & MC_CGM_MUX_4_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_4_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_4_DC_0 & MC_CGM_MUX_4_DC_0_DE_MASK) >>
            MC_CGM_MUX_4_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_LIN3_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->LIN3PCTL & GPR1_PCTL_LIN3PCTL_PCTL_MASK) >>
        GPR1_PCTL_LIN3PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_LIN4_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->LIN4PCTL & GPR1_PCTL_LIN4PCTL_PCTL_MASK) >>
        GPR1_PCTL_LIN4PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_LIN5_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->LIN5PCTL & GPR1_PCTL_LIN5PCTL_PCTL_MASK) >>
        GPR1_PCTL_LIN5PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_LIN9_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_5->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_5->MUX_2_DC_0 & MC_CGM_MUX_2_DC_0_DE_MASK) >>
            MC_CGM_MUX_2_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_2_DC_0 & (uint64)MC_CGM_MUX_2_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR5_PCTL->LIN9PCTL & GPR5_PCTL_LIN9PCTL_PCTL_MASK) >>
        GPR5_PCTL_LIN9PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_LIN10_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_2_DC_0 & (uint64)MC_CGM_MUX_2_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR5_PCTL->LIN10PCTL & GPR5_PCTL_LIN10PCTL_PCTL_MASK) >>
            GPR5_PCTL_LIN10PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_LIN11_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_2_DC_0 & (uint64)MC_CGM_MUX_2_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR5_PCTL->LIN11PCTL & GPR5_PCTL_LIN11PCTL_PCTL_MASK) >>
            GPR5_PCTL_LIN11PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_MSCDSPI_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_7_DC_1 & MC_CGM_MUX_7_DC_1_DE_MASK) >>
            MC_CGM_MUX_7_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_7_DC_1 & (uint64)MC_CGM_MUX_7_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_7_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->MSCDSPIPCTL & GPR0_PCTL_MSCDSPIPCTL_PCTL_MASK) >>
            GPR0_PCTL_MSCDSPIPCTL_PCTL_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_MSCLIN_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_4_DC_0 & MC_CGM_MUX_4_DC_0_DE_MASK) >>
            MC_CGM_MUX_4_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_0->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
                     1U) *
            2U);                               /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->MSCLINPCTL & GPR0_PCTL_MSCLINPCTL_PCTL_MASK) >>
            GPR0_PCTL_MSCLINPCTL_PCTL_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_NANO_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_7_CSS & MC_CGM_MUX_7_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_7_CSS_SELSTAT_SHIFT)]();      /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->GTMNANOPCTL & GPR0_PCTL_GTMNANOPCTL_PCTL_NANO_MASK) >>
            GPR0_PCTL_GTMNANOPCTL_PCTL_NANO_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_DSPI_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_5_CSS & MC_CGM_MUX_5_CSS_SELSTAT_MASK) >>
...
static uint64 Clock_Ip_Get_SPI0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_5_CSS & MC_CGM_MUX_5_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_5_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->DSPI0PCTL & GPR0_PCTL_DSPI0PCTL_PCTL_MASK) >>
            GPR0_PCTL_DSPI0PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SPI1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_5_CSS & MC_CGM_MUX_5_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_5_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->DSPI1PCTL & GPR0_PCTL_DSPI1PCTL_PCTL_MASK) >>
            GPR0_PCTL_DSPI1PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_1US_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_2_DC_0 & MC_CGM_MUX_2_DC_0_DE_MASK) >>
            MC_CGM_MUX_2_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_2_DC_0 & (uint64)MC_CGM_MUX_2_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PSI5_0_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_2_DC_0 & (uint64)MC_CGM_MUX_2_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->PSI50PCTL & GPR0_PCTL_PSI50PCTL_PCTL_MASK) >>
            GPR0_PCTL_PSI50PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_S_TRIG0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_3_DC_0 & MC_CGM_MUX_3_DC_0_DE_MASK) >>
            MC_CGM_MUX_3_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_REG_INTF_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_1_CSS & MC_CGM_MUX_1_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_1_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_1_DC_0 & MC_CGM_MUX_1_DC_0_DE_MASK) >>
            MC_CGM_MUX_1_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P1_DSPI_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SPI2_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->DSPI2PCTL & GPR1_PCTL_DSPI2PCTL_PCTL_MASK) >>
            GPR1_PCTL_DSPI2PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SPI3_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->DSPI3PCTL & GPR1_PCTL_DSPI3PCTL_PCTL_MASK) >>
            GPR1_PCTL_DSPI3PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SPI4_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->DSPI4PCTL & GPR1_PCTL_DSPI4PCTL_PCTL_MASK) >>
            GPR1_PCTL_DSPI4PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P1_LFAST0_REF_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_11_CSS & MC_CGM_MUX_11_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_11_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_11_DC_0 & MC_CGM_MUX_11_DC_0_DE_MASK) >>
            MC_CGM_MUX_11_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)((((uint64)IP_MC_CGM_1->MUX_11_DC_0 & (uint64)MC_CGM_MUX_11_DC_0_DIV_MASK) >>
                     (uint64)MC_CGM_MUX_11_DC_0_DIV_SHIFT) +
            1U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P1_REG_INTF_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_1_CSS & MC_CGM_MUX_1_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_1_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_1_DC_0 & MC_CGM_MUX_1_DC_0_DE_MASK) >>
            MC_CGM_MUX_1_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P2_DBG_ATB_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_2->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P2_REG_INTF_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_2->MUX_1_CSS & MC_CGM_MUX_1_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_1_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_2->MUX_1_DC_0 & MC_CGM_MUX_1_DC_0_DE_MASK) >>
            MC_CGM_MUX_1_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_2->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P5_DSPI_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_5->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SPI8_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_5->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR5_PCTL->DSPI8PCTL & GPR5_PCTL_DSPI8PCTL_PCTL_MASK) >>
            GPR5_PCTL_DSPI8PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SPI9_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_5->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR5_PCTL->DSPI9PCTL & GPR5_PCTL_DSPI9PCTL_PCTL_MASK) >>
            GPR5_PCTL_DSPI9PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P5_REG_INTF_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_5->MUX_1_CSS & MC_CGM_MUX_1_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_1_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_5->MUX_1_DC_0 & MC_CGM_MUX_1_DC_0_DE_MASK) >>
            MC_CGM_MUX_1_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_DDR_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_6->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_6->MUX_0_DC_0 & (uint64)MC_CGM_MUX_6_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_6_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR6_PCTL->DDRPCTL & GPR6_PCTL_DDRPCTL_PCTL_MASK) >>
        GPR6_PCTL_DDRPCTL_PCTL_SHIFT)];         /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_SYS_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P1_SYS_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P2_SYS_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_2->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P3_SYS_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_SYS_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P5_SYS_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_5->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_0_DC_0 & (uint64)MC_CGM_MUX_0_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_0_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P2_MATH_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_2->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_GLB_LBIST_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_8_CSS & MC_CGM_MUX_8_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_8_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_8_DC_0 & MC_CGM_MUX_8_DC_0_DE_MASK) >>
            MC_CGM_MUX_8_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_8_DC_0 & (uint64)MC_CGM_MUX_8_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_8_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTableClkSrc[((IP_RTU0__MC_CGM->MUX_0_CSS &
                                                 RTU_MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
        RTU_MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_RTU0__MC_CGM->MUX_0_DC_0 & RTU_MC_CGM_MUX_0_DC_0_DE_MASK) >>
            RTU_MC_CGM_MUX_0_DC_0_DE_SHIFT)];   /*  Divider enable/disable */
    Frequency /=
        (uint64)((((uint64)IP_RTU0__MC_CGM->MUX_0_DC_0 & (uint64)RTU_MC_CGM_MUX_0_DC_0_DIV_MASK) >>
                     (uint64)RTU_MC_CGM_MUX_0_DC_0_DIV_SHIFT) +
            1U); /*  Apply divider value */
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTableClkSrc[((IP_RTU1__MC_CGM->MUX_0_CSS &
                                                 RTU_MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
        RTU_MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_RTU1__MC_CGM->MUX_0_DC_0 & RTU_MC_CGM_MUX_0_DC_0_DE_MASK) >>
            RTU_MC_CGM_MUX_0_DC_0_DE_SHIFT)];   /*  Divider enable/disable */
    Frequency /=
        (uint64)((((uint64)IP_RTU1__MC_CGM->MUX_0_DC_0 & (uint64)RTU_MC_CGM_MUX_0_DC_0_DIV_MASK) >>
                     (uint64)RTU_MC_CGM_MUX_0_DC_0_DIV_SHIFT) +
            1U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_S_UTIL_CLK_Frequency(void)
{
    uint64 Frequency;
    if (0U ==
        ((IP_MC_CGM_0->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)) {
        Frequency = Clock_Ip_Get_FIRC_CLK_Frequency();
    } else {
        Frequency = Clock_Ip_Get_PERIPHPLL_PHI4_Frequency();
    }
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_2_DC_3 & MC_CGM_MUX_2_DC_3_DE_MASK) >>
            MC_CGM_MUX_2_DC_3_DE_SHIFT)]; /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_2_DC_3 & (uint64)MC_CGM_MUX_2_DC_3_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_3_DIV_SHIFT) +
        1U);                              /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_S_UTIL_CLK_Frequency(void)
{
    uint64 Frequency;
    if (0U ==
        ((IP_MC_CGM_4->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)) {
        Frequency = Clock_Ip_Get_FIRC_CLK_Frequency();
    } else {
        Frequency = Clock_Ip_Get_PERIPHPLL_PHI4_Frequency();
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_2_DC_3 & MC_CGM_MUX_2_DC_3_DE_MASK) >>
            MC_CGM_MUX_2_DC_3_DE_SHIFT)]; /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_2_DC_3 & (uint64)MC_CGM_MUX_2_DC_3_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_3_DIV_SHIFT) +
        1U);                              /*  Apply divider value */
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTableAeClkSrc[((IP_MC_ME_AE->GS & MC_ME_AE_GS_S_SYSCLK_MASK) >>
        MC_ME_AE_GS_S_SYSCLK_SHIFT)](); /*  Selector value */
    return Frequency;
}
#endif
...
static uint64 Clock_Ip_Get_ADC0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->ADC0PCTL & GPR0_PCTL_ADC0PCTL_PCTL_MASK) >>
        GPR0_PCTL_ADC0PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ADC1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->ADC1PCTL & GPR0_PCTL_ADC1PCTL_PCTL_MASK) >>
        GPR0_PCTL_ADC1PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CE_PIT0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency = Frequency >> 2U;
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->PIT0PCTL & GPR3_PCTL_PIT0PCTL_PCTL_MASK) >>
        GPR3_PCTL_PIT0PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CE_PIT1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency = Frequency >> 2U;
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->PIT1PCTL & GPR3_PCTL_PIT1PCTL_PCTL_MASK) >>
        GPR3_PCTL_PIT1PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CE_PIT2_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency = Frequency >> 2U;
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->PIT2PCTL & GPR3_PCTL_PIT2PCTL_PCTL_MASK) >>
        GPR3_PCTL_PIT2PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CE_PIT3_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency = Frequency >> 2U;
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->PIT3PCTL & GPR3_PCTL_PIT3PCTL_PCTL_MASK) >>
        GPR3_PCTL_PIT3PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CE_PIT4_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency = Frequency >> 2U;
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->PIT4PCTL & GPR3_PCTL_PIT4PCTL_PCTL_MASK) >>
        GPR3_PCTL_PIT4PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CE_PIT5_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency = Frequency >> 2U;
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->PIT5PCTL & GPR3_PCTL_PIT5PCTL_PCTL_MASK) >>
        GPR3_PCTL_PIT5PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CTU_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_9_CSS & MC_CGM_MUX_9_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_9_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_9_DC_0 & MC_CGM_MUX_9_DC_0_DE_MASK) >>
            MC_CGM_MUX_9_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_9_DC_0 & (uint64)MC_CGM_MUX_9_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_9_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->CTUPCTL & GPR0_PCTL_CTUPCTL_PCTL_MASK) >>
        GPR0_PCTL_CTUPCTL_PCTL_SHIFT)];         /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_DMACRC0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->EDMA0PCTL & GPR0_PCTL_EDMA0PCTL_PCTL_1_MASK) >>
            GPR0_PCTL_EDMA0PCTL_PCTL_1_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_DMACRC1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->EDMA1PCTL & GPR1_PCTL_EDMA1PCTL_PCTL_1_MASK) >>
            GPR1_PCTL_EDMA1PCTL_PCTL_1_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_DMACRC4_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->EDMA4PCTL & GPR4_PCTL_EDMA4PCTL_PCTL_1_MASK) >>
            GPR4_PCTL_EDMA4PCTL_PCTL_1_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_DMACRC5_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_0_DC_0 & (uint64)MC_CGM_MUX_0_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR5_PCTL->EDMA5PCTL & GPR5_PCTL_EDMA5PCTL_PCTL_1_MASK) >>
            GPR5_PCTL_EDMA5PCTL_PCTL_1_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_DMAMUX0_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->EDMA0PCTL & GPR0_PCTL_EDMA0PCTL_PCTL_2_MASK) >>
            GPR0_PCTL_EDMA0PCTL_PCTL_2_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_DMAMUX1_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->EDMA1PCTL & GPR1_PCTL_EDMA1PCTL_PCTL_2_MASK) >>
            GPR1_PCTL_EDMA1PCTL_PCTL_2_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_DMAMUX4_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_1_CSS & MC_CGM_MUX_1_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_1_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_1_DC_0 & MC_CGM_MUX_1_DC_0_DE_MASK) >>
            MC_CGM_MUX_1_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->EDMA4PCTL & GPR4_PCTL_EDMA4PCTL_PCTL_2_MASK) >>
            GPR4_PCTL_EDMA4PCTL_PCTL_2_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_DMAMUX5_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR5_PCTL->EDMA5PCTL & GPR5_PCTL_EDMA5PCTL_PCTL_2_MASK) >>
            GPR5_PCTL_EDMA5PCTL_PCTL_2_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CLKOUT0_CLK_Frequency(void)
{
    ...
    if (0U ==
        ((IP_MC_CGM_0->MUX_10_CSS & MC_CGM_MUX_10_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_10_CSS_SELSTAT_SHIFT)) {
        Frequency = Clock_Ip_Get_FIRC_CLK_Frequency();
    } else {
        Frequency = Clock_Ip_Get_Px_CLKOUT_SRC_CLK_Frequency();
    }
    Frequency /=
        (uint64)((((uint64)IP_MC_CGM_0->MUX_10_DC_0 & (uint64)MC_CGM_MUX_10_DC_0_DIV_MASK) >>
                     (uint64)MC_CGM_MUX_10_DC_0_DIV_SHIFT) +
            1U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CLKOUT1_CLK_Frequency(void)
{
    ...
    if (0U ==
        ((IP_MC_CGM_1->MUX_10_CSS & MC_CGM_MUX_10_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_10_CSS_SELSTAT_SHIFT)) {
        Frequency = Clock_Ip_Get_FIRC_CLK_Frequency();
    } else {
        Frequency = Clock_Ip_Get_Px_CLKOUT_SRC_CLK_Frequency();
    ...
    Frequency /=
        (uint64)((((uint64)IP_MC_CGM_1->MUX_10_DC_0 & (uint64)MC_CGM_MUX_10_DC_0_DIV_MASK) >>
                     (uint64)MC_CGM_MUX_10_DC_0_DIV_SHIFT) +
            1U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CLKOUT2_CLK_Frequency(void)
{
    ...
    if (0U ==
        ((IP_MC_CGM_4->MUX_6_CSS & MC_CGM_MUX_6_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_6_CSS_SELSTAT_SHIFT)) {
        Frequency = Clock_Ip_Get_FIRC_CLK_Frequency();
    } else {
        Frequency = Clock_Ip_Get_Px_CLKOUT_SRC_CLK_Frequency();
    }
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_6_DC_0 & (uint64)MC_CGM_MUX_6_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_6_DC_0_DIV_SHIFT) +
        1U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CLKOUT3_CLK_Frequency(void)
{
    ...
    if (0U ==
        ((IP_MC_CGM_5->MUX_4_CSS & MC_CGM_MUX_4_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_4_CSS_SELSTAT_SHIFT)) {
        Frequency = Clock_Ip_Get_FIRC_CLK_Frequency();
    } else {
        Frequency = Clock_Ip_Get_Px_CLKOUT_SRC_CLK_Frequency();
    }
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
        1U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CLKOUT4_CLK_Frequency(void)
{
    ...
    if (0U ==
        ((IP_MC_CGM_3->MUX_4_CSS & MC_CGM_MUX_4_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_4_CSS_SELSTAT_SHIFT)) {
        Frequency = Clock_Ip_Get_FIRC_CLK_Frequency();
    } else {
        Frequency = Clock_Ip_Get_Px_CLKOUT_SRC_CLK_Frequency();
    }
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
        1U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_CE_EDMA_CLK_Frequency(void)
{
    ...
    Frequency = Frequency >> 1U;
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->EDMACEPCTL & GPR3_PCTL_EDMACEPCTL_PCTL_MASK) >>
            GPR3_PCTL_EDMACEPCTL_PCTL_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_EDMA0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->EDMA0PCTL & GPR0_PCTL_EDMA0PCTL_PCTL_0_MASK) >>
            GPR0_PCTL_EDMA0PCTL_PCTL_0_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_EDMA1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->EDMA1PCTL & GPR1_PCTL_EDMA1PCTL_PCTL_0_MASK) >>
            GPR1_PCTL_EDMA1PCTL_PCTL_0_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_EDMA3_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->EDMA3PCTL & GPR3_PCTL_EDMA3PCTL_PCTL_MASK) >>
            GPR3_PCTL_EDMA3PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_EDMA4_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->EDMA4PCTL & GPR4_PCTL_EDMA4PCTL_PCTL_0_MASK) >>
            GPR4_PCTL_EDMA4PCTL_PCTL_0_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_EDMA5_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_0_DC_0 & (uint64)MC_CGM_MUX_0_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR5_PCTL->EDMA5PCTL & GPR5_PCTL_EDMA5PCTL_PCTL_0_MASK) >>
            GPR5_PCTL_EDMA5PCTL_PCTL_0_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ETH0_TX_MII_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_6_CSS & MC_CGM_MUX_6_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_6_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_6_DC_0 & MC_CGM_MUX_6_DC_0_DE_MASK) >>
            MC_CGM_MUX_6_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_6_DC_0 & (uint64)MC_CGM_MUX_6_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_6_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ENET0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_6_CSS & MC_CGM_MUX_6_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_6_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->ENET0PCTL & GPR1_PCTL_ENET0PCTL_PCTL_MASK) >>
            GPR1_PCTL_ENET0PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_6_DC_0 & (uint64)MC_CGM_MUX_6_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_6_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_P3_CAN_PE_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_3->MUX_3_DC_0 & MC_CGM_MUX_3_DC_0_DE_MASK) >>
            MC_CGM_MUX_3_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_FLEXCAN0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN0PCTL & GPR3_PCTL_CAN0PCTL_PCTL_MASK) >>
        GPR3_PCTL_CAN0PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN1PCTL & GPR3_PCTL_CAN1PCTL_PCTL_MASK) >>
        GPR3_PCTL_CAN1PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN2_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN2PCTL & GPR3_PCTL_CAN2PCTL_PCTL_MASK) >>
        GPR3_PCTL_CAN2PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN3_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN3PCTL & GPR3_PCTL_CAN3PCTL_PCTL_MASK) >>
        GPR3_PCTL_CAN3PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN4_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN4PCTL & GPR3_PCTL_CAN4PCTL_PCTL_MASK) >>
        GPR3_PCTL_CAN4PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN5_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN5PCTL & GPR3_PCTL_CAN5PCTL_PCTL_MASK) >>
        GPR3_PCTL_CAN5PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN6_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN6PCTL & GPR3_PCTL_CAN6PCTL_PCTL_MASK) >>
        GPR3_PCTL_CAN6PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN7_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN7PCTL & GPR3_PCTL_CAN7PCTL_PCTL_MASK) >>
        GPR3_PCTL_CAN7PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN8_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN8PCTL & GPR3_PCTL_CAN8PCTL_PCTL_MASK) >>
        GPR3_PCTL_CAN8PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN9_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN9PCTL & GPR3_PCTL_CAN9PCTL_PCTL_MASK) >>
        GPR3_PCTL_CAN9PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN10_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN10PCTL & GPR3_PCTL_CAN10PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN10PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN11_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN11PCTL & GPR3_PCTL_CAN11PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN11PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN12_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN12PCTL & GPR3_PCTL_CAN12PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN12PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN13_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN13PCTL & GPR3_PCTL_CAN13PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN13PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN14_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN14PCTL & GPR3_PCTL_CAN14PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN14PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN15_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN15PCTL & GPR3_PCTL_CAN15PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN15PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN16_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN16PCTL & GPR3_PCTL_CAN16PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN16PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN17_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN17PCTL & GPR3_PCTL_CAN17PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN17PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN18_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN18PCTL & GPR3_PCTL_CAN18PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN18PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN19_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN19PCTL & GPR3_PCTL_CAN19PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN19PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN20_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN20PCTL & GPR3_PCTL_CAN20PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN20PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN21_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN21PCTL & GPR3_PCTL_CAN21PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN21PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN22_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN22PCTL & GPR3_PCTL_CAN22PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN22PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_FLEXCAN23_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->CAN23PCTL & GPR3_PCTL_CAN23PCTL_PCTL_MASK) >>
            GPR3_PCTL_CAN23PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_IIIC0_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->I3C0PCTL & GPR0_PCTL_I3C0PCTL_PCTL_MASK) >>
        GPR0_PCTL_I3C0PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_IIIC1_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->I3C1PCTL & GPR1_PCTL_I3C1PCTL_PCTL_MASK) >>
        GPR1_PCTL_I3C1PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_IIIC2_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->I3C2PCTL & GPR4_PCTL_I3C2PCTL_PCTL_MASK) >>
        GPR4_PCTL_I3C2PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_LIN_BAUD_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_8_CSS & MC_CGM_MUX_8_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_8_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_8_DC_0 & MC_CGM_MUX_8_DC_0_DE_MASK) >>
            MC_CGM_MUX_8_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_8_DC_0 & (uint64)MC_CGM_MUX_8_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_8_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_LIN6_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_8_CSS & MC_CGM_MUX_8_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_8_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->LIN6PCTL & GPR4_PCTL_LIN6PCTL_PCTL_MASK) >>
        GPR4_PCTL_LIN6PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_8_DC_0 & (uint64)MC_CGM_MUX_8_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_8_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_LIN7_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_8_CSS & MC_CGM_MUX_8_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_8_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->LIN7PCTL & GPR4_PCTL_LIN7PCTL_PCTL_MASK) >>
        GPR4_PCTL_LIN7PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_8_DC_0 & (uint64)MC_CGM_MUX_8_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_8_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_LIN8_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_8_CSS & MC_CGM_MUX_8_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_8_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->LIN8PCTL & GPR4_PCTL_LIN8PCTL_PCTL_MASK) >>
        GPR4_PCTL_LIN8PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_8_DC_0 & (uint64)MC_CGM_MUX_8_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_8_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_P0_CLKOUT_SRC_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableCLKOUT0SEL[((IP_GPR0->CLKOUT0SEL & GPR0_CLKOUT0SEL_MUXSEL_MASK) >>
        GPR0_CLKOUT0SEL_MUXSEL_SHIFT)](); /*  Selector value */
}
...
static uint64 Clock_Ip_Get_P0_GTM_TS_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_7_DC_0 & MC_CGM_MUX_7_DC_0_DE_MASK) >>
            MC_CGM_MUX_7_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_0->MUX_7_DC_0 & (uint64)MC_CGM_MUX_7_DC_0_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_7_DC_0_DIV_SHIFT) +
                     1U) *
            5U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_125K_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_2_DC_1 & MC_CGM_MUX_2_DC_1_DE_MASK) >>
            MC_CGM_MUX_2_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_2_DC_1 & (uint64)MC_CGM_MUX_2_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_189K_CLK_Frequency(void)
{
    ...
    if (((IP_MC_CGM_0->MUX_2_DC_2 & MC_CGM_MUX_2_DC_2_DIV_FMT_MASK) >>
            MC_CGM_MUX_2_DC_2_DIV_FMT_SHIFT) == 1U) {
        Multi = 10U;
    } else if (((IP_MC_CGM_0->MUX_2_DC_2 & MC_CGM_MUX_2_DC_2_DIV_FMT_MASK) >>
                   MC_CGM_MUX_2_DC_2_DIV_FMT_SHIFT) == 2U) {
        Multi = 100U;
    } else if (((IP_MC_CGM_0->MUX_2_DC_2 & MC_CGM_MUX_2_DC_2_DIV_FMT_MASK) >>
                   MC_CGM_MUX_2_DC_2_DIV_FMT_SHIFT) == 3U) {
        Multi = 1000U;
    } else {
        Multi = 1U;
    }
    Fin = Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
        MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Fin &= Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_2_DC_2 & MC_CGM_MUX_2_DC_2_DE_MASK) >>
        MC_CGM_MUX_2_DC_2_DE_SHIFT)];       /*  Divider enable/disable */
    Div = (uint64)((((uint64)IP_MC_CGM_0->MUX_2_DC_2 & (uint64)MC_CGM_MUX_2_DC_2_DIV_MASK) >>
                       (uint64)MC_CGM_MUX_2_DC_2_DIV_SHIFT) +
        1U);                                /*  Apply divider value */
...
static uint64 Clock_Ip_Get_P0_PSI5_S_BAUD_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_2_DC_5 & MC_CGM_MUX_2_DC_5_DE_MASK) >>
            MC_CGM_MUX_2_DC_5_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_2_DC_5 & (uint64)MC_CGM_MUX_2_DC_5_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_5_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_S_CORE_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_2_DC_5 & MC_CGM_MUX_2_DC_5_DE_MASK) >>
            MC_CGM_MUX_2_DC_5_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_0->MUX_2_DC_5 & (uint64)MC_CGM_MUX_2_DC_5_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_2_DC_5_DIV_SHIFT) +
                     1U) *
            2U); /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_P0_PSI5_S_TRIG1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_3_DC_1 & MC_CGM_MUX_3_DC_1_DE_MASK) >>
            MC_CGM_MUX_3_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_3_DC_1 & (uint64)MC_CGM_MUX_3_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_S_TRIG2_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_3_DC_2 & MC_CGM_MUX_3_DC_2_DE_MASK) >>
            MC_CGM_MUX_3_DC_2_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_3_DC_2 & (uint64)MC_CGM_MUX_3_DC_2_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_2_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_S_TRIG3_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_3_DC_3 & MC_CGM_MUX_3_DC_3_DE_MASK) >>
            MC_CGM_MUX_3_DC_3_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_3_DC_3 & (uint64)MC_CGM_MUX_3_DC_3_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_3_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_S_UART_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_2_DC_4 & MC_CGM_MUX_2_DC_4_DE_MASK) >>
            MC_CGM_MUX_2_DC_4_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_2_DC_4 & (uint64)MC_CGM_MUX_2_DC_4_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_4_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_S_WDOG0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_3_DC_4 & MC_CGM_MUX_3_DC_4_DE_MASK) >>
            MC_CGM_MUX_3_DC_4_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_3_DC_4 & (uint64)MC_CGM_MUX_3_DC_4_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_4_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_S_WDOG1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_3_DC_5 & MC_CGM_MUX_3_DC_5_DE_MASK) >>
            MC_CGM_MUX_3_DC_5_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_3_DC_5 & (uint64)MC_CGM_MUX_3_DC_5_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_5_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_S_WDOG2_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_3_DC_6 & MC_CGM_MUX_3_DC_6_DE_MASK) >>
            MC_CGM_MUX_3_DC_6_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_3_DC_6 & (uint64)MC_CGM_MUX_3_DC_6_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_6_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_PSI5_S_WDOG3_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_3_DC_7 & MC_CGM_MUX_3_DC_7_DE_MASK) >>
            MC_CGM_MUX_3_DC_7_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_3_DC_7 & (uint64)MC_CGM_MUX_3_DC_7_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_7_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P0_REG_INTF_2X_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_1_CSS & MC_CGM_MUX_1_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_1_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_0->MUX_1_DC_1 & MC_CGM_MUX_1_DC_1_DE_MASK) >>
            MC_CGM_MUX_1_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_1_DC_1 & (uint64)MC_CGM_MUX_1_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P1_CLKOUT_SRC_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableCLKOUT1SEL[((IP_GPR1->CLKOUT1SEL & GPR1_CLKOUT1SEL_MUXSEL_MASK) >>
        GPR1_CLKOUT1SEL_MUXSEL_SHIFT)](); /*  Selector value */
}
...
static uint64 Clock_Ip_Get_ETH_TS_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_5_CSS & MC_CGM_MUX_5_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_5_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_5_DC_0 & MC_CGM_MUX_5_DC_0_DE_MASK) >>
            MC_CGM_MUX_5_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_5_DC_0 & (uint64)MC_CGM_MUX_5_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_5_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ETH_TS_DIV4_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_5_DC_0 & MC_CGM_MUX_5_DC_0_DE_MASK) >>
            MC_CGM_MUX_5_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_1->MUX_5_DC_0 & (uint64)MC_CGM_MUX_5_DC_0_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_5_DC_0_DIV_SHIFT) +
                     1U) *
            4U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ETH0_REF_RMII_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_7_CSS & MC_CGM_MUX_7_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_7_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_7_DC_2 & MC_CGM_MUX_7_DC_2_DE_MASK) >>
            MC_CGM_MUX_7_DC_2_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_7_DC_2 & (uint64)MC_CGM_MUX_7_DC_2_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_7_DC_2_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ETH0_RX_MII_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_7_CSS & MC_CGM_MUX_7_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_7_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_7_DC_0 & MC_CGM_MUX_7_DC_0_DE_MASK) >>
            MC_CGM_MUX_7_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_7_DC_0 & (uint64)MC_CGM_MUX_7_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_7_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ETH0_RX_RGMII_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_7_CSS & MC_CGM_MUX_7_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_7_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_7_DC_1 & MC_CGM_MUX_7_DC_1_DE_MASK) >>
            MC_CGM_MUX_7_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_7_DC_1 & (uint64)MC_CGM_MUX_7_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_7_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ETH0_TX_RGMII_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_6_CSS & MC_CGM_MUX_6_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_6_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_6_DC_1 & MC_CGM_MUX_6_DC_1_DE_MASK) >>
            MC_CGM_MUX_6_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_6_DC_1 & (uint64)MC_CGM_MUX_6_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_6_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ETH1_REF_RMII_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_9_CSS & MC_CGM_MUX_9_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_9_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_9_DC_2 & MC_CGM_MUX_9_DC_2_DE_MASK) >>
            MC_CGM_MUX_9_DC_2_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_9_DC_2 & (uint64)MC_CGM_MUX_9_DC_2_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_9_DC_2_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ETH1_RX_MII_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_9_CSS & MC_CGM_MUX_9_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_9_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_9_DC_0 & MC_CGM_MUX_9_DC_0_DE_MASK) >>
            MC_CGM_MUX_9_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_9_DC_0 & (uint64)MC_CGM_MUX_9_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_9_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ETH1_RX_RGMII_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_9_CSS & MC_CGM_MUX_9_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_9_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_9_DC_1 & MC_CGM_MUX_9_DC_1_DE_MASK) >>
            MC_CGM_MUX_9_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_9_DC_1 & (uint64)MC_CGM_MUX_9_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_9_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ETH1_TX_MII_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_8_CSS & MC_CGM_MUX_8_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_8_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_8_DC_0 & MC_CGM_MUX_8_DC_0_DE_MASK) >>
            MC_CGM_MUX_8_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_8_DC_0 & (uint64)MC_CGM_MUX_8_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_8_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_ETH1_TX_RGMII_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_8_CSS & MC_CGM_MUX_8_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_8_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_8_DC_1 & MC_CGM_MUX_8_DC_1_DE_MASK) >>
            MC_CGM_MUX_8_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_8_DC_1 & (uint64)MC_CGM_MUX_8_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_8_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P1_LFAST1_REF_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_12_CSS & MC_CGM_MUX_12_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_12_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_12_DC_0 & MC_CGM_MUX_12_DC_0_DE_MASK) >>
            MC_CGM_MUX_12_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)((((uint64)IP_MC_CGM_1->MUX_12_DC_0 & (uint64)MC_CGM_MUX_12_DC_0_DIV_MASK) >>
                     (uint64)MC_CGM_MUX_12_DC_0_DIV_SHIFT) +
            1U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P1_NETC_AXI_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_14_CSS & MC_CGM_MUX_14_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_14_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_14_DC_0 & MC_CGM_MUX_14_DC_0_DE_MASK) >>
            MC_CGM_MUX_14_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)((((uint64)IP_MC_CGM_1->MUX_14_DC_0 & (uint64)MC_CGM_MUX_14_DC_0_DIV_MASK) >>
                     (uint64)MC_CGM_MUX_14_DC_0_DIV_SHIFT) +
            1U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P1_LIN_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_1->MUX_4_DC_0 & MC_CGM_MUX_4_DC_0_DE_MASK) >>
            MC_CGM_MUX_4_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_1->MUX_4_DC_0 & (uint64)MC_CGM_MUX_4_DC_0_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_4_DC_0_DIV_SHIFT) +
                     1U) *
            2U); /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_P3_AES_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_3->MUX_2_DC_1 & MC_CGM_MUX_2_DC_1_DE_MASK) >>
            MC_CGM_MUX_2_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_2_DC_1 & (uint64)MC_CGM_MUX_2_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P3_CLKOUT_SRC_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableCLKOUT4SEL[((IP_GPR3->CLKOUT4SEL & GPR3_CLKOUT4SEL_MUXSEL_MASK) >>
        GPR3_CLKOUT4SEL_MUXSEL_SHIFT)](); /*  Selector value */
}
...
static uint64 Clock_Ip_Get_P3_DBG_TS_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_3->MUX_2_DC_0 & MC_CGM_MUX_2_DC_0_DE_MASK) >>
            MC_CGM_MUX_2_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_2_DC_0 & (uint64)MC_CGM_MUX_2_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P3_REG_INTF_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_3->MUX_1_CSS & MC_CGM_MUX_1_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_1_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_3->MUX_1_DC_0 & MC_CGM_MUX_1_DC_0_DE_MASK) >>
            MC_CGM_MUX_1_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_3->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_CLKOUT_SRC_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableCLKOUT2SEL[((IP_GPR4->CLKOUT2SEL & GPR4_CLKOUT2SEL_MUXSEL_MASK) >>
        GPR4_CLKOUT2SEL_MUXSEL_SHIFT)](); /*  Selector value */
}
...
static uint64 Clock_Ip_Get_P4_DSPI60_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_5_CSS & MC_CGM_MUX_5_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_5_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_EMIOS_LCU_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_11_CSS & MC_CGM_MUX_11_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_11_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_LIN_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_8_DC_0 & MC_CGM_MUX_8_DC_0_DE_MASK) >>
            MC_CGM_MUX_8_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_4->MUX_8_DC_0 & (uint64)MC_CGM_MUX_8_DC_0_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_8_DC_0_DIV_SHIFT) +
                     1U) *
            2U); /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_P4_PSI5_125K_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_2_DC_1 & MC_CGM_MUX_2_DC_1_DE_MASK) >>
            MC_CGM_MUX_2_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_2_DC_1 & (uint64)MC_CGM_MUX_2_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_189K_CLK_Frequency(void)
{
    ...
    if (((IP_MC_CGM_4->MUX_2_DC_2 & MC_CGM_MUX_2_DC_2_DIV_FMT_MASK) >>
            MC_CGM_MUX_2_DC_2_DIV_FMT_SHIFT) == 1U) {
        Multi = 10U;
    } else if (((IP_MC_CGM_4->MUX_2_DC_2 & MC_CGM_MUX_2_DC_2_DIV_FMT_MASK) >>
                   MC_CGM_MUX_2_DC_2_DIV_FMT_SHIFT) == 2U) {
        Multi = 100U;
    } else if (((IP_MC_CGM_4->MUX_2_DC_2 & MC_CGM_MUX_2_DC_2_DIV_FMT_MASK) >>
                   MC_CGM_MUX_2_DC_2_DIV_FMT_SHIFT) == 3U) {
    ...
    Fin = Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
        MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Fin &= Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_2_DC_2 & MC_CGM_MUX_2_DC_2_DE_MASK) >>
        MC_CGM_MUX_2_DC_2_DE_SHIFT)];       /*  Divider enable/disable */
    Div = (uint64)((((uint64)IP_MC_CGM_4->MUX_2_DC_2 & (uint64)MC_CGM_MUX_2_DC_2_DIV_MASK) >>
                       (uint64)MC_CGM_MUX_2_DC_2_DIV_SHIFT) +
        1U);                                /*  Apply divider value */
...
static uint64 Clock_Ip_Get_P4_PSI5_S_BAUD_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_2_DC_5 & MC_CGM_MUX_2_DC_5_DE_MASK) >>
            MC_CGM_MUX_2_DC_5_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_2_DC_5 & (uint64)MC_CGM_MUX_2_DC_5_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_5_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_S_CORE_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_2_DC_5 & MC_CGM_MUX_2_DC_5_DE_MASK) >>
            MC_CGM_MUX_2_DC_5_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_4->MUX_2_DC_5 & (uint64)MC_CGM_MUX_2_DC_5_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_2_DC_5_DIV_SHIFT) +
                     1U) *
            2U); /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_P4_PSI5_S_TRIG0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_3_DC_0 & MC_CGM_MUX_3_DC_0_DE_MASK) >>
            MC_CGM_MUX_3_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_3_DC_0 & (uint64)MC_CGM_MUX_3_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_S_TRIG1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_3_DC_1 & MC_CGM_MUX_3_DC_1_DE_MASK) >>
            MC_CGM_MUX_3_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_3_DC_1 & (uint64)MC_CGM_MUX_3_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_S_TRIG2_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_3_DC_2 & MC_CGM_MUX_3_DC_2_DE_MASK) >>
            MC_CGM_MUX_3_DC_2_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_3_DC_2 & (uint64)MC_CGM_MUX_3_DC_2_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_2_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_S_TRIG3_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_3_DC_3 & MC_CGM_MUX_3_DC_3_DE_MASK) >>
            MC_CGM_MUX_3_DC_3_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_3_DC_3 & (uint64)MC_CGM_MUX_3_DC_3_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_3_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_S_UART_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_2_DC_4 & MC_CGM_MUX_2_DC_4_DE_MASK) >>
            MC_CGM_MUX_2_DC_4_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_2_DC_4 & (uint64)MC_CGM_MUX_2_DC_4_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_4_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_S_WDOG0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_3_DC_4 & MC_CGM_MUX_3_DC_4_DE_MASK) >>
            MC_CGM_MUX_3_DC_4_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_3_DC_4 & (uint64)MC_CGM_MUX_3_DC_4_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_4_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_S_WDOG1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_3_DC_5 & MC_CGM_MUX_3_DC_5_DE_MASK) >>
            MC_CGM_MUX_3_DC_5_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_3_DC_5 & (uint64)MC_CGM_MUX_3_DC_5_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_5_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_S_WDOG2_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_3_DC_6 & MC_CGM_MUX_3_DC_6_DE_MASK) >>
            MC_CGM_MUX_3_DC_6_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_3_DC_6 & (uint64)MC_CGM_MUX_3_DC_6_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_6_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_S_WDOG3_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_3_CSS & MC_CGM_MUX_3_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_3_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_3_DC_7 & MC_CGM_MUX_3_DC_7_DE_MASK) >>
            MC_CGM_MUX_3_DC_7_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_3_DC_7 & (uint64)MC_CGM_MUX_3_DC_7_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_3_DC_7_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_QSPI0_2X_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_7_CSS & MC_CGM_MUX_7_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_7_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_7_DC_0 & MC_CGM_MUX_7_DC_0_DE_MASK) >>
            MC_CGM_MUX_7_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_7_DC_0 & (uint64)MC_CGM_MUX_7_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_7_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_QSPI0_1X_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_7_DC_0 & MC_CGM_MUX_7_DC_0_DE_MASK) >>
            MC_CGM_MUX_7_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_4->MUX_7_DC_0 & (uint64)MC_CGM_MUX_7_DC_0_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_7_DC_0_DIV_SHIFT) +
                     1U) *
            2U); /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_P4_QSPI1_2X_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_9_CSS & MC_CGM_MUX_9_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_9_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_9_DC_1 & MC_CGM_MUX_9_DC_1_DE_MASK) >>
            MC_CGM_MUX_9_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_9_DC_1 & (uint64)MC_CGM_MUX_9_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_9_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_QSPI1_1X_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_9_DC_1 & MC_CGM_MUX_9_DC_1_DE_MASK) >>
            MC_CGM_MUX_9_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_4->MUX_9_DC_1 & (uint64)MC_CGM_MUX_9_DC_1_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_9_DC_1_DIV_SHIFT) +
                     1U) *
            2U); /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_P4_REG_INTF_2X_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_1_CSS & MC_CGM_MUX_1_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_1_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_1_DC_1 & MC_CGM_MUX_1_DC_1_DE_MASK) >>
            MC_CGM_MUX_1_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_1_DC_1 & (uint64)MC_CGM_MUX_1_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_SDHC_IP_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_10_CSS & MC_CGM_MUX_10_CSS_SELSTAT_MASK) >>
...
static uint64 Clock_Ip_Get_P5_DIPORT_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_5->MUX_5_CSS & MC_CGM_MUX_5_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_5_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P5_AE_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_5->MUX_5_CSS & MC_CGM_MUX_5_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_5_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_5->MUX_5_DC_0 & MC_CGM_MUX_5_DC_0_DE_MASK) >>
            MC_CGM_MUX_5_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_5_DC_0 & (uint64)MC_CGM_MUX_5_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_5_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P5_CANXL_PE_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_5->MUX_5_CSS & MC_CGM_MUX_5_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_5_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_5->MUX_5_DC_1 & MC_CGM_MUX_5_DC_1_DE_MASK) >>
            MC_CGM_MUX_5_DC_1_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_5_DC_1 & (uint64)MC_CGM_MUX_5_DC_1_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_5_DC_1_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P5_CANXL_CHI_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_5->MUX_5_CSS & MC_CGM_MUX_5_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_5_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_5->MUX_5_DC_2 & MC_CGM_MUX_5_DC_2_DE_MASK) >>
            MC_CGM_MUX_5_DC_2_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_5_DC_2 & (uint64)MC_CGM_MUX_5_DC_2_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_5_DC_2_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P5_CLKOUT_SRC_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableCLKOUT3SEL[((IP_GPR5->CLKOUT3SEL & GPR5_CLKOUT3SEL_MUXSEL_MASK) >>
        GPR5_CLKOUT3SEL_MUXSEL_SHIFT)](); /*  Selector value */
}
...
static uint64 Clock_Ip_Get_P5_LIN_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_5->MUX_2_DC_0 & MC_CGM_MUX_2_DC_0_DE_MASK) >>
            MC_CGM_MUX_2_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_5->MUX_2_DC_0 & (uint64)MC_CGM_MUX_2_DC_0_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_2_DC_0_DIV_SHIFT) +
                     1U) *
            2U); /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_P6_REG_INTF_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_6->MUX_1_CSS & MC_CGM_MUX_1_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_1_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_6->MUX_1_DC_0 & MC_CGM_MUX_1_DC_0_DE_MASK) >>
            MC_CGM_MUX_1_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_6->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PIT0_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->EDMA0PCTL & GPR0_PCTL_EDMA0PCTL_PCTL_3_MASK) >>
            GPR0_PCTL_EDMA0PCTL_PCTL_3_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PIT1_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->EDMA1PCTL & GPR1_PCTL_EDMA1PCTL_PCTL_3_MASK) >>
            GPR1_PCTL_EDMA1PCTL_PCTL_3_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PIT4_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->EDMA4PCTL & GPR4_PCTL_EDMA4PCTL_PCTL_3_MASK) >>
            GPR4_PCTL_EDMA4PCTL_PCTL_3_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PIT5_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_5->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
        ...
        1U);                                    /*  Apply divider value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR5_PCTL->EDMA5PCTL & GPR5_PCTL_EDMA5PCTL_PCTL_3_MASK) >>
            GPR5_PCTL_EDMA5PCTL_PCTL_3_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_PSI5_1US_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_MC_CGM_4->MUX_2_DC_0 & MC_CGM_MUX_2_DC_0_DE_MASK) >>
            MC_CGM_MUX_2_DC_0_DE_SHIFT)];       /*  Divider enable/disable */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_2_DC_0 & (uint64)MC_CGM_MUX_2_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_PSI5_1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->PSI51PCTL & GPR4_PCTL_PSI51PCTL_PCTL_MASK) >>
            GPR4_PCTL_PSI51PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_2_DC_0 & (uint64)MC_CGM_MUX_2_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_PSI5S_0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_0->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->PSI5S0PCTL & GPR0_PCTL_PSI5S0PCTL_PCTL_MASK) >>
            GPR0_PCTL_PSI5S0PCTL_PCTL_SHIFT)];  /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_2_DC_3 & (uint64)MC_CGM_MUX_2_DC_3_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_3_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_PSI5S_1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_2_CSS & MC_CGM_MUX_2_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_2_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->PSI5S1PCTL & GPR4_PCTL_PSI5S1PCTL_PCTL_MASK) >>
            GPR4_PCTL_PSI5S1PCTL_PCTL_SHIFT)];  /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_2_DC_3 & (uint64)MC_CGM_MUX_2_DC_3_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_2_DC_3_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_QSPI0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_7_CSS & MC_CGM_MUX_7_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_7_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->QSPI0PCTL & GPR4_PCTL_QSPI0PCTL_PCTL_MASK) >>
            GPR4_PCTL_QSPI0PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_4->MUX_7_DC_0 & (uint64)MC_CGM_MUX_7_DC_0_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_7_DC_0_DIV_SHIFT) +
                     1U) *
...
static uint64 Clock_Ip_Get_QSPI1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_9_CSS & MC_CGM_MUX_9_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_9_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->QSPI1PCTL & GPR4_PCTL_QSPI1PCTL_PCTL_MASK) >>
            GPR4_PCTL_QSPI1PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    Frequency /=
        (uint64)(((((uint64)IP_MC_CGM_4->MUX_9_DC_1 & (uint64)MC_CGM_MUX_9_DC_1_DIV_MASK) >>
                      (uint64)MC_CGM_MUX_9_DC_1_DIV_SHIFT) +
                     1U) *
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTableClkSrc[((IP_RTU0__MC_CGM->MUX_1_CSS &
                                                 RTU_MC_CGM_MUX_1_CSS_SELSTAT_MASK) >>
        RTU_MC_CGM_MUX_1_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_RTU0__MC_CGM->MUX_1_DC_0 & RTU_MC_CGM_MUX_1_DC_0_DE_MASK) >>
            RTU_MC_CGM_MUX_1_DC_0_DE_SHIFT)];   /*  Divider enable/disable */
    Frequency /=
        (uint64)((((uint64)IP_RTU0__MC_CGM->MUX_1_DC_0 & (uint64)RTU_MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                     (uint64)RTU_MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
            1U); /*  Apply divider value */
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTableClkSrc[((IP_RTU1__MC_CGM->MUX_1_CSS &
                                                 RTU_MC_CGM_MUX_1_CSS_SELSTAT_MASK) >>
        RTU_MC_CGM_MUX_1_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_au32EnableDivider[((IP_RTU1__MC_CGM->MUX_1_DC_0 & RTU_MC_CGM_MUX_1_DC_0_DE_MASK) >>
            RTU_MC_CGM_MUX_1_DC_0_DE_SHIFT)];   /*  Divider enable/disable */
    Frequency /=
        (uint64)((((uint64)IP_RTU1__MC_CGM->MUX_1_DC_0 & (uint64)RTU_MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                     (uint64)RTU_MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
            1U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_RXLUT_CLK_Frequency(void)
{
    ...
    Frequency = Frequency >> 1U;
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR3_PCTL->RXLUTPCTL & GPR3_PCTL_RXLUTPCTL_PCTL_MASK) >>
            GPR3_PCTL_RXLUTPCTL_PCTL_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_SDHC_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_9_CSS & MC_CGM_MUX_9_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_9_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_9_DC_0 & (uint64)MC_CGM_MUX_9_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_9_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SDHC0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_9_CSS & MC_CGM_MUX_9_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_9_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->SDHCPCTL & GPR4_PCTL_SDHCPCTL_PCTL_MASK) >>
        GPR4_PCTL_SDHCPCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_9_DC_0 & (uint64)MC_CGM_MUX_9_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_9_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    return Frequency;
...
static uint64 Clock_Ip_Get_SINC_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_0->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->SINCPCTL & GPR0_PCTL_SINCPCTL_PCTL_MASK) >>
        GPR0_PCTL_SINCPCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SIPI0_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->SIPI0PCTL & GPR1_PCTL_SIPI0PCTL_PCTL_MASK) >>
            GPR1_PCTL_SIPI0PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SIPI1_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_1->MUX_0_CSS & MC_CGM_MUX_0_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_0_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->SIPI1PCTL & GPR1_PCTL_SIPI1PCTL_PCTL_MASK) >>
            GPR1_PCTL_SIPI1PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SIUL2_0_CLK_Frequency(void)
{
    ...
    Frequency = Clock_Ip_Get_FIRC_CLK_Frequency();
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR0_PCTL->SIUL0PCTL & GPR0_PCTL_SIUL0PCTL_PCTL_MASK) >>
            GPR0_PCTL_SIUL0PCTL_PCTL_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SIUL2_1_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->SIUL1PCTL & GPR1_PCTL_SIUL1PCTL_PCTL_MASK) >>
            GPR1_PCTL_SIUL1PCTL_PCTL_SHIFT)];      /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SIUL2_4_CLK_Frequency(void)
{
    ...
    Frequency = Clock_Ip_Get_FIRC_CLK_Frequency();
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->SIUL4PCTL & GPR4_PCTL_SIUL4PCTL_PCTL_MASK) >>
            GPR4_PCTL_SIUL4PCTL_PCTL_SHIFT)]; /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SIUL2_5_CLK_Frequency(void)
{
    ...
    Frequency = Clock_Ip_Get_FIRC_CLK_Frequency(); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR5_PCTL->SIUL5PCTL & GPR5_PCTL_SIUL5PCTL_PCTL_MASK) >>
            GPR5_PCTL_SIUL5PCTL_PCTL_SHIFT)];      /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_P4_DSPI_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_4_CSS & MC_CGM_MUX_4_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_4_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SPI5_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_5_CSS & MC_CGM_MUX_5_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_5_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->DSPI5PCTL & GPR4_PCTL_DSPI5PCTL_PCTL_MASK) >>
            GPR4_PCTL_DSPI5PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SPI6_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_5_CSS & MC_CGM_MUX_5_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_5_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->DSPI6PCTL & GPR4_PCTL_DSPI6PCTL_PCTL_MASK) >>
            GPR4_PCTL_DSPI6PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SPI7_CLK_Frequency(void)
{
    ...
    Frequency =
        Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM_4->MUX_4_CSS & MC_CGM_MUX_4_CSS_SELSTAT_MASK) >>
            MC_CGM_MUX_4_CSS_SELSTAT_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->DSPI7PCTL & GPR4_PCTL_DSPI7PCTL_PCTL_MASK) >>
            GPR4_PCTL_DSPI7PCTL_PCTL_SHIFT)];   /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SRX0_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_1->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR1_PCTL->SRX0PCTL & GPR1_PCTL_SRX0PCTL_PCTL_MASK) >>
        GPR1_PCTL_SRX0PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
static uint64 Clock_Ip_Get_SRX1_CLK_Frequency(void)
{
    ...
    Frequency /= (uint64)((((uint64)IP_MC_CGM_4->MUX_1_DC_0 & (uint64)MC_CGM_MUX_1_DC_0_DIV_MASK) >>
                              (uint64)MC_CGM_MUX_1_DC_0_DIV_SHIFT) +
        1U);                                    /*  Apply divider value */
    Frequency &= Clock_Ip_u64EnableGate[((IP_GPR4_PCTL->SRX1PCTL & GPR4_PCTL_SRX1PCTL_PCTL_MASK) >>
        GPR4_PCTL_SRX1PCTL_PCTL_SHIFT)];        /*  Apply peripheral clock gate */
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = (((IP_CORE_PLL->PLLCLKMUX & PLLDIG_PLLCLKMUX_REFCLKSEL_MASK) >>
                     PLLDIG_PLLCLKMUX_REFCLKSEL_SHIFT) == 0U) ?
        Clock_Ip_Get_FIRC_CLK_Frequency() :
        Clock_Ip_Get_FXOSC_CLK_Frequency(); /*  Selector value */
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = (((IP_PERIPH_PLL->PLLCLKMUX & PLLDIG_PLLCLKMUX_REFCLKSEL_MASK) >>
                     PLLDIG_PLLCLKMUX_REFCLKSEL_SHIFT) == 0U) ?
        Clock_Ip_Get_FIRC_CLK_Frequency() :
        Clock_Ip_Get_FXOSC_CLK_Frequency(); /*  Selector value */
    return Frequency;
...
static uint64 Clock_Ip_Get_Px_PSI5_S_UTIL_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTablePSI5_S_UTIL_MULTIPLEX[Clock_Ip_u64PSI5_S_UTILIndex](); /*  Selector
                                                                                          value */
}
...
static uint64 Clock_Ip_Get_PLL_VCO(const PLLDIG_Type* Base)
{
    ...
    Fin = (((Base->PLLCLKMUX & PLLDIG_PLLCLKMUX_REFCLKSEL_MASK) >>
               PLLDIG_PLLCLKMUX_REFCLKSEL_SHIFT) == 0U) ?
        Clock_Ip_Get_FIRC_CLK_Frequency() :
        Clock_Ip_Get_FXOSC_CLK_Frequency(); /* input freq */
    Rdiv = ((uint64)((uint64)Base->PLLDV & (uint64)PLLDIG_PLLDV_RDIV_MASK) >>
        (uint64)PLLDIG_PLLDV_RDIV_SHIFT);   /* Rdiv */
    Mfi = ((uint64)((uint64)Base->PLLDV & (uint64)PLLDIG_PLLDV_MFI_MASK) >>
        (uint64)PLLDIG_PLLDV_MFI_SHIFT);    /* Mfi */
    Mfn = ((uint64)((uint64)Base->PLLFD & (uint64)PLLDIG_PLLFD_MFN_MASK) >>
        (uint64)PLLDIG_PLLFD_MFN_SHIFT);    /* Mfn */

    Var1 = Mfi / Rdiv;                      /* Mfi divided by Rdiv */
    Var2 = Mfi - (Var1 * Rdiv);             /* Mfi minus Var1 multiplied by Rdiv */
    Var3 = (Rdiv << CLOCK_IP_MUL_BY_16384) + (Rdiv << CLOCK_IP_MUL_BY_2048); /* Rdiv multiplied by
                                                                                18432 */
...
static uint64 Clock_Ip_Get_LFAST_PLL_VCO(const LFAST_Type* Base)
{
    ...
    if (0U != Fin) {
        ...
        if ((PllMode == ((uint64)(Fin * PllMode) / Fin)) &&
            (CLOCK_IP_LFAST_PLL_VCO_MAX_FREQ >= Fout)) {
            if (((Fin / Prediv) > ((Fin * PllMode) / (2U * Prediv))) &&
                (Fout < (Fout + (Fin / Prediv)))) {
                /*Fout += (Fin/Prediv) when PllMode = 0 and Fout += (Fin/(2*Prediv)) when PllMode =
                 * 1*/
    ...
    if ((1U != ((Base->PLLLSR & LFAST_PLLLSR_PLDCR_MASK) >> LFAST_PLLLSR_PLDCR_SHIFT)) ||
        (TRUE == Overflow)) {
        Fout = 0U;
    }
...
static uint64 Clock_Ip_Get_DFS_OUTPUT(const DFS_Type* Base, uint32 Channel, uint64 Fin)
{
    ...
    Divider = ((Mfi << CLOCK_IP_MUL_BY_32) + (Mfi << CLOCK_IP_MUL_BY_4) + Mfn); /* mfi multiplied by
                                                                                   36 add mfn */
    DividerResult = (uint64)((Divider != 0U) ? (Fin / Divider) : 0U); /* Fin divide by Divider */
    DividerModulo = (uint64)(Fin - (Divider * DividerResult)); /* Fin minus DividerResult multiplied
                                                                  by Divider */

    if (Divider != 0U) {
        if ((DividerResult << CLOCK_IP_MUL_BY_16) <=
            ((DividerResult << CLOCK_IP_MUL_BY_16) + (DividerResult << CLOCK_IP_MUL_BY_2))) {
        ...
        if (Fout <=
            (Fout +
                (((DividerModulo << CLOCK_IP_MUL_BY_16) + (DividerModulo << CLOCK_IP_MUL_BY_2)) /
                    Divider))) {
            Fout += ((DividerModulo << CLOCK_IP_MUL_BY_16) + (DividerModulo << CLOCK_IP_MUL_BY_2)) /
                Divider;
        } else {
            Overflow = TRUE;
        }
...
static uint64 Clock_Ip_Get_LFAST0_PLL_CLK_Frequency(void)
{
    return (((IP_LFAST_0->PLLLSR & LFAST_PLLLSR_PLDCR_MASK) >> LFAST_PLLLSR_PLDCR_SHIFT) == 1U) ?
        Clock_Ip_Get_LFAST_PLL_VCO(IP_LFAST_0) :
        0U;
}
/* Return LFAST0_PLL_CLK_ frequency */
static uint64 Clock_Ip_Get_LFAST1_PLL_CLK_Frequency(void)
{
    return (((IP_LFAST_1->PLLLSR & LFAST_PLLLSR_PLDCR_MASK) >> LFAST_PLLLSR_PLDCR_SHIFT) == 1U) ?
        Clock_Ip_Get_LFAST_PLL_VCO(IP_LFAST_1) :
        0U;
}
/*==================================================================================================
*                                       GLOBAL FUNCTIONS
