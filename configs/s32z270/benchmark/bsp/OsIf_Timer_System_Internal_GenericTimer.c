...
*                                       FILE VERSION CHECKS
==================================================================================================*/
/* Check if OsIf_Timer_System_Internal_GenericTimer.c file and OsIf_DeviceRegisters.h file are of
 * the same vendor */
#if (OSIF_TIMER_SYS_INTER_GENERICTIMER_VENDOR_ID_C != OSIF_DEVICE_REGISTERS_VENDOR_ID)
#error \
    "OsIf_Timer_System_Internal_GenericTimer.c and OsIf_DeviceRegisters.h have different vendor ids"
#endif
/* Check if OsIf_Timer_System_Internal_GenericTimer.c file and OsIf_DeviceRegisters.h file are of
 * the same Autosar version */
#if ((OSIF_TIMER_SYS_INTER_GENERICTIMER_AR_RELEASE_MAJOR_VERSION_C !=   \
         OSIF_DEVICE_REGISTERS_AR_RELEASE_MAJOR_VERSION) ||             \
    (OSIF_TIMER_SYS_INTER_GENERICTIMER_AR_RELEASE_MINOR_VERSION_C !=    \
        OSIF_DEVICE_REGISTERS_AR_RELEASE_MINOR_VERSION) ||              \
    (OSIF_TIMER_SYS_INTER_GENERICTIMER_AR_RELEASE_REVISION_VERSION_C != \
        OSIF_DEVICE_REGISTERS_AR_RELEASE_REVISION_VERSION))
#error \
    "AUTOSAR Version Numbers of OsIf_Timer_System_Internal_GenericTimer.c and OsIf_DeviceRegisters.h are different"
#endif
/* Check if OsIf_Timer_System_Internal_GenericTimer.c file and OsIf_DeviceRegisters.h file are of
 * the same Software version */
#if ((OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_MAJOR_VERSION_C != \
         OSIF_DEVICE_REGISTERS_SW_MAJOR_VERSION) ||           \
    (OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_MINOR_VERSION_C !=  \
        OSIF_DEVICE_REGISTERS_SW_MINOR_VERSION) ||            \
    (OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_PATCH_VERSION_C !=  \
        OSIF_DEVICE_REGISTERS_SW_PATCH_VERSION))
#error \
    "Software Version Numbers of OsIf_Timer_System_Internal_GenericTimer.c and OsIf_DeviceRegisters.h are different"
#endif

/* Check if OsIf_Timer_System_Internal_GenericTimer.c file and OsIf_Cfg.h file are of the same
 * vendor */
...
#error \
    "AUTOSAR Version Numbers of OsIf_Timer_System_Internal_GenericTimer.c and OsIf_Cfg.h are different"
#endif
/* Check if OsIf_Timer_System_Internal_GenericTimer.c file and OsIf_Cfg.h file are of the same
 * Software version */
...
#error \
    "Software Version Numbers of OsIf_Timer_System_Internal_GenericTimer.c and OsIf_Cfg.h are different"
#endif

/* Check if OsIf_Timer_System_Internal_GenericTimer.c file and
 * OsIf_Timer_System_Internal_GenericTimer.h file are of the same vendor */
#if (OSIF_TIMER_SYS_INTER_GENERICTIMER_VENDOR_ID_C != OSIF_TIMER_SYS_INTER_GENERICTIMER_VENDOR_ID)
#error \
    "OsIf_Timer_System_Internal_GenericTimer.c and OsIf_Timer_System_Internal_GenericTimer.h have different vendor ids"
#endif
/* Check if OsIf_Timer_System_Internal_GenericTimer.c file and
 * OsIf_Timer_System_Internal_GenericTimer.h file are of the same Autosar version */
#if ((OSIF_TIMER_SYS_INTER_GENERICTIMER_AR_RELEASE_MAJOR_VERSION_C !=   \
...
#error \
    "AUTOSAR Version Numbers of OsIf_Timer_System_Internal_GenericTimer.c and OsIf_Timer_System_Internal_GenericTimer.h are different"
#endif
/* Check if OsIf_Timer_System_Internal_GenericTimer.c file and
 * OsIf_Timer_System_Internal_GenericTimer.h file are of the same Software version */
#if ((OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_MAJOR_VERSION_C !=   \
         OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_MAJOR_VERSION) || \
    (OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_MINOR_VERSION_C !=    \
        OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_MINOR_VERSION) ||  \
    (OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_PATCH_VERSION_C !=    \
        OSIF_TIMER_SYS_INTER_GENERICTIMER_SW_PATCH_VERSION))
#error \
    "Software Version Numbers of OsIf_Timer_System_Internal_GenericTimer.c and OsIf_Timer_System_Internal_GenericTimer.h are different"
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
/* Check if OsIf_Timer_System_Internal_GenericTimer.c file and Mcal.h file are of the same Autosar
 * version */
#if ((OSIF_TIMER_SYS_INTER_GENERICTIMER_AR_RELEASE_MAJOR_VERSION_C != \
...
#error \
    "AUTOSAR Version Numbers of OsIf_Timer_System_Internal_GenericTimer.c and Mcal.h are different"
#endif
#endif
...
static void write_CNTFRQ(uint32 val)
{
    ...
    /*LDRA_NOANALYSIS*/
    ASMV_KEYWORD(WRITE_CNTFRQ_INSTR : /* No Output */
                 : [Rd] "r"(val64));
    /*LDRA_ANALYSIS*/
}
...
static void write_CNTP_CTL(uint32 val)
{
    ...
    /*LDRA_NOANALYSIS*/
    ASMV_KEYWORD(WRITE_CNTP_CTL_INSTR : /* No Output */
                 : [Rd] "r"(val64));
    /*LDRA_ANALYSIS*/
}
...
static void write_CNTP_TVAL(uint32 val)
{
    ...
    /*LDRA_NOANALYSIS*/
    ASMV_KEYWORD(WRITE_CNTP_TVAL_INSTR : /* No Output */
                 : [Rd] "r"(val64));
    /*LDRA_ANALYSIS*/
}
...
static uint32 read_CNTP_TVAL(void)
{
    ...
    /*LDRA_NOANALYSIS*/
    ASMV_KEYWORD(READ_CNTP_TVAL_INSTR : [Rd] "=r"(cntp_tval));
    /*LDRA_ANALYSIS*/
    return cntp_tval;
}
#elif ((MCAL_PLATFORM_ARM == MCAL_ARM_AARCH32) || (MCAL_PLATFORM_ARM == MCAL_ARM_RARCH))
...
#if (MCAL_PLATFORM_ARM == MCAL_ARM_AARCH64)
    /*accessing register in T32 mode from R52 core is not possible. To be check later.
     * Implementation now is only done for AArch64*/
