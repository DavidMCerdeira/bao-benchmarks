...
uint8 Det_RuntimeInstanceId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET Runtime
                                                                            instance ID*/
uint8 Det_RuntimeApiId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET Runtime API ID*/
uint8 Det_RuntimeErrorId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET Runtime Error
                                                                         ID*/
/* Variables to store last DET transient error */
uint8 Det_TransientInstanceId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET Transient
                                                                              instance ID*/
uint8 Det_TransientApiId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET Transient API
                                                                         ID*/
uint8 Det_TransientFaultId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET Transient
                                                                           Error ID*/
...
#include "Det_MemMap.h"
uint16 Det_TransientModuleId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET Transient
                                                                             module ID*/
uint16 Det_ModuleId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS];        /**< @brief DET module ID*/
uint16 Det_RuntimeModuleId[DET_NO_ECU_CORES][DET_MAX_NUMBER_OF_EVENTS]; /**< @brief DET Runtime
                                                                           module ID*/
